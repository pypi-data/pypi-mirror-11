...
extras = {
    ...
    'db': [
        ...
        # TODO: Looks like SQLAlchemy-Continuum is rather out of date and the API
        # for SQLAlchemy-Utils has broken for it somehow as of 0.30.15.  For now
        # this is easiest but maybe should submit a patch to Continuum project?
        'SQLAlchemy-Utils<0.30.15',     #                       0.30.14
        ],
