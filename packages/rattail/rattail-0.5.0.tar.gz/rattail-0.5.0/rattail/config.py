...
def make_config(files=None, usedb=None, preferdb=None, env=os.environ, winsvc=None):
    """
...
def get_user_file(self, filename, createdir=False):
    """
    ...
    """
    return os.path.join(get_user_dir(create=create), filename)
