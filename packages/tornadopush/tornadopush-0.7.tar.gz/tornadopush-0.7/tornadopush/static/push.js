...
(function(tp) {
    ...
    tp.FallbackChannelListener = (function() {
        ...
        _.prototype.tryWebSocket = function() {
            ...
            ws.onconnecting = function(reconnecting, closeEvent) {
                if (reconnecting && self.reconnectAttempts >= 1) {
                    ws.close();
                    self.fallback();
                }
            };
            ...
            ws.onclose = function(event) {
                if ([1002, 1003, 1006].indexOf(event.code) !== -1) {
                    self.fallback();
                }
            };
        };
        ...
        _.prototype.dispatch = function() {
            if (this.listener) {
                return this.listener.dispatch(event, callback)
            }
        };
