...
"""metameta 0.0.0.42 - meta-transcriptome/genome mapping analysis toolkit
...
def main():
    ...
    if args.docs:
        documentation = resource_string(__name__, 'Documentation.txt')
        subprocess.call(['less', documentation])
    elif args.tool is None:
        print(__doc__)
    else:
        script = location + args.tool + '.py'
        subprocess.call(['python', script, str(args.arguments)])
