...
``psq`` is an example Python implementation of a simple `distributed
task queue <>`__ using `Google Cloud
Pub/Sub <https://cloud.google.com/pubsub/>`__.
...
this library. See `contributing.md <CONTRIBUTING.md>`__.
