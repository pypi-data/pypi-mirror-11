...
def vt_rel_time_def(T: float, T1: float, idata: np.ndarray, molecule: MoleculeQuasi, n: float,
                    model: str='VSS') -> float:
    """Calculates the VT relaxation time using the strict definition, using the FHO model for VT transition probability
    calculation
    ...
    n : float
        the numeric density of the mixture
    model : str, optional
        the elastic cross-section model to be used, possible values:
