...
DefinitionsCertificate = {'required': ['private_key', 'public_key_certificate', 'certificate_chain'], 'properties': {'public_key_certificate': {'type': 'string'}, 'private_key': {'type': 'string'}, 'certificate_chain': {'type': 'string'}}}
DefinitionsSlave = {'required': ['address'], 'properties': {'address': {'type': 'string'}}}
DefinitionsFrontend = {'required': ['protocol'], 'properties': {'protocol': {'default': 'http', 'enum': ['http', 'https', 'tcp', 'ssl'], 'type': 'string', 'description': 'not support udp'}, 'port': {'type': 'integer', 'description': 'intranet port. readonly. decided by GLB'}}}
DefinitionsBackend = {'properties': {'tag': {'type': 'string'}, 'port': {'type': 'integer'}, 'address': {'type': 'string', 'format': 'ipv4'}}}
DefinitionsEntrypoint = {'required': ['domain', 'port'], 'properties': {'domain': {'type': 'string', 'format': 'hostname'}, 'cipher': {'type': 'string'}, 'protocol': {'default': 'http', 'enum': ['http', 'https', 'tcp', 'ssl'], 'type': 'string', 'description': 'not support udp'}, 'port': {'type': 'integer'}, 'certificate': DefinitionsCertificate}}
...
validators = {
    ...
    ('balancer_balancer_name_entrypoints', 'DELETE'): {'args': {'required': [], 'properties': {'domain': {'type': 'string'}, 'protocol': {'type': 'string'}, 'port': {'type': 'string'}}}},
    ...
    ('balancer_balancer_name_backends', 'DELETE'): {'args': {'required': [], 'properties': {'tag': {'type': 'string', 'description': 'delete number'}, 'port': {'type': 'string'}, 'address': {'type': 'string'}}}},
    ('balancer_balancer_name_frontend', 'PUT'): {'json': DefinitionsFrontend},
}

filters = {
    ('balancer', 'POST'): {201: {'headers': None, 'schema': DefinitionsBalancer}},
