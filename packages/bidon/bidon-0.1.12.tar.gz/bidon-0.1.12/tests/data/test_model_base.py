...
class DataModelBaseTestCase(unittest.TestCase):
  ...
  def test_to_dict(self):
    ...
    self.assertEqual(dict(first_name="Mr.", last_name="Kite", age=0, updated_at=None, created_at=None, id=None), p1.to_dict())
    self.assertEqual(dict(first_name="Mr."), p1.to_dict(include_keys=["first_name"]))
    self.assertEqual(dict(first_name="Mr.", last_name="Kite", age=0), p1.to_dict(exclude_keys=["updated_at", "created_at", "id"]))
