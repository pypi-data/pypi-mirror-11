...
def getBeautifulSoup(text, features='lxml'):
    """Return BeautifulSoup with lxml feature by default"""
...
class JSONRPCCallbackMixin(object):
    ...
    def setUpJ01Dialog(self, content):
        ...
        if len(tags) == 1:
            tag = tags[0]
            part = getBeautifulSoup(j01DialogHolder, "html.parser")
            tag.append(part)
...
class JSONRPCMixin(object):
    ...
    def doReplaceContent(self, cssSelector, content):
        ...
        if len(tags) < 1:
            ...
            tag = tags[0]
            tag.clear()
            part = getBeautifulSoup(content, "html.parser")
            tag.append(part)
...
class Browser(p01.testbrowser.control.ControlFactoryMixin, JSONRPCMixin,
    ...
    def _html(self):
        ...
        return getBeautifulSoup(self._dom, 'html.parser')
    ...
    def form2String(self, selector=None):
        ...
        self.node2String('|'.join(selector))
