...
def project_decrease_permissions(object_id, input_params={}, always_retry=True, **kwargs):
    ...
    For more info, see: https://wiki.dnanexus.com/API-Specification-v1.0.0/Project%20Permissions%20and%20Sharing#API-method%3A-%2Fproject-xxxx%2FdecreasePermissions
    """
...
def project_leave(object_id, input_params={}, always_retry=True, **kwargs):
    ...
    For more info, see: https://wiki.dnanexus.com/API-Specification-v1.0.0/Project%20Permissions%20and%20Sharing#API-method:-/project-xxxx/leave
    """
