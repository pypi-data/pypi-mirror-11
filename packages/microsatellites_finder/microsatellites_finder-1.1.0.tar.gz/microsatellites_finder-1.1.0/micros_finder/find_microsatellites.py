...
def run(fasta_file, length, min_repetitions, alphabet, cores, imperfect, strict, progress=False):
    ...
    micro = utils.Microsatellite(length, min_repetitions, imperfect, strict, alphabet=alphabet)
