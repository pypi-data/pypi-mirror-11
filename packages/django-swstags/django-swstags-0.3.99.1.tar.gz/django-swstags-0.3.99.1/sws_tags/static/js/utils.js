	...
	actual_month= now.getMonth();
		...
		switch(period){
			...
			case 'pweek':
				...
				to_date = new Date(now.getFullYear(),actual_month,now.getDate()-7,finish_hour,finish_minutes,finish_seconds);
				break;
			case 'pmonth':
	...
	finish_seconds = 59 
		switch(period){
			...
			case 'pweek':
				...
				to_date = new Date(now.getFullYear(),now.getMonth(),now.getDate()-7,finish_hour,finish_minutes,finish_seconds);
				break;
			case 'pmonth':
