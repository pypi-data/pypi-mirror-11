...
def sendProgressBarEvent(channel=None, view_name='', value='', message='', error=False, connection_redis=''):
	sendEvent(channel, connection_redis, 'progressbar',{'view_name':view_name,'value':value,'message':message, 'error': error})

def sendBubbleNotificationEvent(channel=None, view_name='', value='', mode='add', connection_redis=''):
	sendEvent(channel, connection_redis, 'bubblenotification',{'view_name':view_name,'value':value,'mode':mode})

def sendBubbleNotificationBlinkEvent(channel=None, view_name='', connection_redis=''):
	sendEvent(channel, connection_redis, 'bubblenotificationblink', {'view_name':view_name})


def sendDashboardEvent(channel=None, data='', connection_redis=''):
