...
@app.orgmetric('/total-passed-executions', 'sum', 'passedexecutions', title='Success executions')
...
@app.repometric('/total-passed-repo-executions', 'sum', 'passedexecutions', title='Success executions')
