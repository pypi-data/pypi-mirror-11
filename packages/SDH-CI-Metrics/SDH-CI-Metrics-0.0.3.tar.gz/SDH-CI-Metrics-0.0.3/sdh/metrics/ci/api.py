...
@app.orgtbd('/avg-build-time', 'buildtime', title='Build time')
...
@app.repometric('/repo-time-to-fix', 'avg', 'timetofix', title='Time to fix')
...
@app.orgmetric('/time-to-fix', 'avg', 'timetofix', title='Time to fix')
