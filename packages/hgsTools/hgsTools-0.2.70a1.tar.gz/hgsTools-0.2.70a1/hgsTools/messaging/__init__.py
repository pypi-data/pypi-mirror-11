...
msg_args = {
                         ...
                         'preprocess': ['input', 'group_id'],
                         'preprocessed': ['group_id', 'app_type', 'app_input_file', 'app_output_file', 'app_params'],
                         'preprocessing_completed': ['input', 'group_id'],
                         
                         'postprocess': ['group_id', 'apps_list', 'outputs_list'],
                         'postprocessed': ['group_id', 'output', 'apps_list'],
