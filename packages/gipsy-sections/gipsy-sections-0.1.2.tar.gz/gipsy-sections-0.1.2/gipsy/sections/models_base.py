...
class SectionBase(UserStampedModel, ActivatorModel, TitleSlugDescriptionModel,
    ...
    TEMPLATE_NAME_CHOICES = (
        ...
        ('sections/row.html', 'Sections row'),
        ('sections/information.html', 'Information'),
        ('sections/information_inverted.html', 'Information (inverted)'),
        ('sections/partners.html', 'Partners'),
        ('sections/links.html', 'Links row'),
        ('sections/newsletter.html', 'Newsletter'),
        ('sections/blob.html', 'Sections blob'),
        ('sections/text.html', 'Text'),
        ('sections/infographic.html', 'Infographic'),
        ('sections/slideshow.html', 'Slideshow'),
        ('sections/slideshow_small.html', 'Slideshow (small)'),
    )
    ...
    section_content_type = models.ForeignKey(ContentType, null=True, blank=True, related_name='sections')
