...
class ModelToDict(Serializer):
    """
    Aqui é possivel otimizar.
    Transforma em JSON para depois destransformar.
    Pode ser eliminado totalmente a serializacao para JSON.
    """
    def __init__(self):
        super(ModelToDict, self).__init__()
        self._current = None
    ...
    def getvalue(self):
        ...
        :return: Value
        """
        return json.loads(super(ModelToDict, self).getvalue())
