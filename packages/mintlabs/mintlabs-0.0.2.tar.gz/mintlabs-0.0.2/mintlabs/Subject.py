...
class Subject:
    ...
    def name(self, new_subject_name):
        ...
        answer = self.project.connection.send_request(
    ...
    @property
    def all_data(self):
        response = self._project.connection.send_request(
    ...
    def input_containers(self):
        ...
        result = [a for a in all_analysis if a["patient_secret_name"] == self._name]
        for r in result:
