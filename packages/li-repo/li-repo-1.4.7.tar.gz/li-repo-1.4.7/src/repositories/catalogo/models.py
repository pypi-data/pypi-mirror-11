...
class Produto(models.Model):
    ...
    imagens = models.ManyToManyField('repositories_plataforma.Imagem', through='ProdutoImagem')
    grades = models.ManyToManyField('repositories_catalogo.Grade', through='ProdutoGrade')
    categorias = models.ManyToManyField('repositories_catalogo.Categoria', through='ProdutoCategoria')
...
class ProdutoCategoria(models.Model):
    ...
    produto = models.ForeignKey('repositories_catalogo.Produto', related_name='produto_categorias', on_delete=models.CASCADE)
...
class ProdutoImagem(models.Model):
    ...
    produto = models.ForeignKey('repositories_catalogo.Produto', related_name='produto_imagens', on_delete=models.CASCADE)
...
class ProdutoGrade(models.Model):
    ...
    produto = models.ForeignKey('repositories_catalogo.Produto', related_name='produto_grades', on_delete=models.CASCADE)
