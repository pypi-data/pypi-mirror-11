...
def test_plot_poly_fidi_mesh():
    ...
    plot_poly_fidi_mesh(diameter=30, x_spacing=3, y_spacing=3, n=6, centre_mesh='auto')
    ...
    plot_poly_fidi_mesh(diameter=30, x_spacing=3, y_spacing=4, n=5, centre_mesh='auto')
