...
FEDORA_ROOT_NONSSL = 'http://libfeddev1.library.emory.edu:8080/fedora/'

# fedora 3.8 qa
# FEDORA_ROOT = 'https://libfedqa1.library.emory.edu:8443/fedora/'
# FEDORA_ROOT_NONSSL = 'http://libfedqa.library.emory.edu:8080/fedora/'
