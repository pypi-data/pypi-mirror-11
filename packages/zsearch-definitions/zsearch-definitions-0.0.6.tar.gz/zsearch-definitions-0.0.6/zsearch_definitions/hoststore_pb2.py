...
_DELTA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='atom', full_name='zsearch.Delta.atom', index=7,
...
_DELTA.fields_by_name['atom'].message_type = _PROTOCOLATOM
