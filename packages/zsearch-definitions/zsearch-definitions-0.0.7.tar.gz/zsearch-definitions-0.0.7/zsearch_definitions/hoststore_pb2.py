...
_DELTA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='atoms', full_name='zsearch.Delta.atoms', index=7,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='zsearch.Delta.version', index=15,
...
_DELTA.fields_by_name['atoms'].message_type = _PROTOCOLATOM
