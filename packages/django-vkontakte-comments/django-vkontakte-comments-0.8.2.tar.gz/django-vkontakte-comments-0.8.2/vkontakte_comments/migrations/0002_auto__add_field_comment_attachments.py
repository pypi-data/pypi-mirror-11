...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.attachments'
        db.add_column(u'vkontakte_comments_comment', 'attachments',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.attachments'
        db.delete_column(u'vkontakte_comments_comment', 'attachments')
