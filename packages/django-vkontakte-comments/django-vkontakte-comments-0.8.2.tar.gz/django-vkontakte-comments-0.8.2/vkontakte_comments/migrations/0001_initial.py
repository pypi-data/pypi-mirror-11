...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vkontakte_comments_comment', (
            ...
            ('author_content_type', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name=u'content_type_authors_vkontakte_comments_comments', null=True, to=orm['contenttypes.ContentType'])),
            ('author_id', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_index=True)),
            ('owner_content_type', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name=u'content_type_owners_vkontakte_comments_comments', null=True, to=orm['contenttypes.ContentType'])),
            ...
            ('object_content_type', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='content_type_objects_vkontakte_comments', to=orm['contenttypes.ContentType'])),
            ...
            ('reply_for_id', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_index=True)),
            ('reply_to', self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['vkontakte_comments.Comment'], null=True)),
        ))
        db.send_create_signal(u'vkontakte_comments', ['Comment'])

        # Adding M2M table for field likes_users on 'Comment'
        m2m_table_name = db.shorten_name(u'vkontakte_comments_comment_likes_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm[u'vkontakte_comments.comment'], null=False)),
            ('user', models.ForeignKey(orm[u'vkontakte_users.user'], null=False))
        ))
        # Adding field 'Comment.like_users.through.time_from'
        db.add_column('vkontakte_comments_comment_likes_users', 'time_from',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Comment.like_users.through.time_to'
        db.add_column('vkontakte_comments_comment_likes_users', 'time_to',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'vkontakte_comments_comment')

        # Removing M2M table for field likes_users on 'Comment'
        db.delete_table(db.shorten_name(u'vkontakte_comments_comment_likes_users'))
    ...
    complete_apps = ['vkontakte_comments']
