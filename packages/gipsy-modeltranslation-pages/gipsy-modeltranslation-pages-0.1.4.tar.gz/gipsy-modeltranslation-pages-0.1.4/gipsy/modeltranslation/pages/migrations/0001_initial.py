    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_slug', models.SlugField(verbose_name='slug', blank=True)),
                ('url_slug_en', models.SlugField(null=True, verbose_name='slug', blank=True)),
                ('url_slug_de', models.SlugField(null=True, verbose_name='slug', blank=True)),
                ('url_slug_fr', models.SlugField(null=True, verbose_name='slug', blank=True)),
        ...
        migrations.AlterUniqueTogether(
            name='page',
            unique_together=set([('parent', 'url_slug')]),
        ),
    ]
