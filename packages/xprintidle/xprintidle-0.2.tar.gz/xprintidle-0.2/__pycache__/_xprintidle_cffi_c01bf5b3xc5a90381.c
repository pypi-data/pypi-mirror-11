...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_xprintidle_cffi_c01bf5b3xc5a90381",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__xprintidle_cffi_c01bf5b3xc5a90381(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_xprintidle_cffi_c01bf5b3xc5a90381(void)
{
  PyObject *lib;
  lib = Py_InitModule("_xprintidle_cffi_c01bf5b3xc5a90381", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
