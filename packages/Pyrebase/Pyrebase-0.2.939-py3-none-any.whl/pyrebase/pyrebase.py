...
class Firebase():
    """ Firebase Interface """
    def __init__(self, fire_base_url, fire_base_secret, uid=False, email=False, password=False):
    ...
    def info(self):
        return self.fire_base_url, self.token, self.email, self.password, self.uid
