...
from cubes.skos import (LABELS_RDF_MAPPING, register_skos_rdf_list_mapping,
                        register_skos_rdf_output_mapping, rdfio)
...
class AbstractRDFAdapter(EntityAdapter):
    ...
    def add_entities_to_rdf_graph(self, graph):
        ...
        rdfio.add_entities_to_rdf_graph(graph, [self.entity], self.registry)
...
class ConceptSchemeRDFListAdapter(AbstractRDFAdapter):
    ...
    register_rdf_mapping = staticmethod(register_skos_rdf_list_mapping)
...
class ConceptSchemeRDFPrimaryAdapter(AbstractRDFAdapter):
    ...
    register_rdf_mapping = staticmethod(register_skos_rdf_output_mapping)
    ...
    def fill(self, graph):
        ...
        for concept in self.entity.reverse_in_scheme:
            ...
            for rtype in LABELS_RDF_MAPPING:
