...
class Inflow(BC):
    ...
    def set_phase_velocities(self, phase, velocity):
        self.raw['CORE']['phase' + str(phase) + '_u'] = velocity[0]
        self.raw['CORE']['phase' + str(phase) + '_v'] = velocity[1]
        self.raw['CORE']['phase' + str(phase) + '_w'] = velocity[2]
