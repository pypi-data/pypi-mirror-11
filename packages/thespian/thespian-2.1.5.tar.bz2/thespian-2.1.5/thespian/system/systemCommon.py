...
class systemCommonBase(object):
    ...
    def _send_intent_to_transport(self, intent):
        ...
        try:
            ...
            # KWQ: where does _addrManager get updated with this address?  Shouldn't we check right here and now to see if addrManager can provide the translation instead of awaiting one?  Is that our production bug?
