...
the id will be omitted on manage forms and can thus not be changed
after hostel creation.

The add and manage form pages let us define the 'dimensions' of the
hostel and and configure blocks with their assignment to either
...
Reserved beds won't be allocated automatically. The beds remains
