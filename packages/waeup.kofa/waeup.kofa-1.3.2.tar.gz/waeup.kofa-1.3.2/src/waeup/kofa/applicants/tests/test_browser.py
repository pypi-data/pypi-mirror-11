## $Id: test_browser.py 13254 2015-09-09 13:06:31Z henrik $
##
...
class ApplicantRegisterTests(ApplicantsFullSetup):
    ...
    def test_check_status(self):
        ...
        self.browser.getControl(name="applicant_id").value = 'nonsense'
        ...
        self.browser.getControl(name="applicant_id").value = self.applicant.applicant_id
        ...
        self.browser.getControl(name="lastname").value = 'Lion'
        self.browser.getControl("Submit").click()
        self.assertTrue('Application status of' in self.browser.contents)
        self.assertTrue('You have not yet submitted your application' in self.browser.contents)
        ...
        self.assertTrue('Department of Unnamed Department (dep1)' in self.browser.contents)
        self.assertTrue('Faculty of Unnamed Faculty (NA)' in self.browser.contents)
