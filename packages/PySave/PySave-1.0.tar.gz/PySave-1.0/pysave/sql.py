...
Description: Tool to help you save things in sql
Version: 1
Date:
"""
...
class mssql:
    """ Handles all mssql informtaion """

    def __init__(self, user, password, server, database):
        """ Creates the sqlalchemy engine with given paramerters """
        self.engine = sqlalchemy.create_engine('mssql+pyodbc://' + user + ':' + password + '@' + server + '/' + database)
        self.conn = None
