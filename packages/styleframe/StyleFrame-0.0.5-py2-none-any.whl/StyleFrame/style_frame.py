...
class StyleFrame(object):
    ...
    def apply_style_by_indexes(self, indexes_to_color=None, cols_name=None, color='white', bold=False, size=12, number_format='General'):
        '''
        applies a certain style to the provided indexes in the dataframe in the provided columns
        :param indexes_to_color: indexes to apply the style to
