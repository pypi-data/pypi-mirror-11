How to contribute to Vumi Message Store
=======================================

VumiMessage Store is an Open Source software project under the BSD license.
...
2.  Run the tests, we'll only accept pull requests with passing tests.
    Ensure that the tests run with ``trial vumi_message_store`` and that you're
