...
class TargetFile(object):
    ...
    def TargetList(self, filename):
        ...
        try:
            ...
            pass #NOMOREPRINTS print "There was an error reading from the target input file."
...
class SitesFile(object):
    ...
    def getXMLTree(self):
        ...
        try:
            ...
            pass #NOMOREPRINTS print "There was an error reading from the sites input file.",
            pass #NOMOREPRINTS print "Please check that the XML file is present and correctly formatted."
