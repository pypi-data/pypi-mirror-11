...
from programa import meuprograma
import statistics
import json
from os import path

lista_entrevistados = list()
...
def carrega_dados():
    ...
    try:
        arquivo_json = open(path.join(home,'dados/dados.json'),'r') # Abre o arquivo no disco
...
def salvar_dados():
    ...
    try:
        arquivo_json = open(path.join(home."dados/dados.json"), "w") # Abre o arquivo e limpa
