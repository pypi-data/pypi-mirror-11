"""this module implement stats for data engine
...
class TimeStats(list):
    """six element of list
    """
    def __init__(self, call_count=0, total_call_time=0.0, total_exclusive_call_time=0.0, max_call_time=0.0,
                 min_call_time=0.0, sum_of_squares=0.0):
        super(TimeStats, self).__init__([call_count, total_call_time, total_exclusive_call_time, max_call_time,
    ...
    def merge_time_metric(self, metric):
        ...
        self.merge_original_time_metric(metric.duration, metric.exclusive)
...
class ApdexStats(list):
    ...
    def __init__(self, satisfying=0, tolerating=0, frustrating=0, apdex_t=0.0):
        super(ApdexStats, self).__init__([satisfying, tolerating, frustrating, apdex_t])
