...
kwargs = dict(
    name="tingyun",
    version=version,
    description="Python application performance monitor client, It's main usage is working with python web framework.",
    long_description="Application performance monitor client, which is base on TingYun platform. Can monitor "
