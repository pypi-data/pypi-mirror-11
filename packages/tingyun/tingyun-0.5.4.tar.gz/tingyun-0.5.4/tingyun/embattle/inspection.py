...
class Embattle(object):
    ...
    def __init__(self, config_file):
        ...
        if not config_file:
            console.error('Agent config file is not found, agent start failed.')
    ...
    def inspect_prerequisites(self):
        ...
        :return:
        """
        console.info("Inspecting config file %s", self.config_file)
    ...
    def _process_setting(self, section, option, method='get', mapper=None, hide=False):
        ...
        try:
            ...
            if not hide:
                console.info("No section[%s] in configure file", section)
        except ConfigParser.NoOptionError:
            if not hide:
                console.info("No option[%s] in configure file", option)
    ...
    def execute(self):
        ...
        console.info("Stating init agent environment ..%s.", self._settings)
