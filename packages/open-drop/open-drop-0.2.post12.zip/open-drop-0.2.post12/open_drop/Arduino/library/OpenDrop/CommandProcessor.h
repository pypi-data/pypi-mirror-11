#ifndef ___OPEN_DROP__COMMAND_PROCESSOR___
#define ___OPEN_DROP__COMMAND_PROCESSOR___
...
public:
  ...
  UInt8Array process_command(UInt8Array request_arr, UInt8Array buffer) {
    ...
    switch (request_arr.data[0]) {
        ...
        case CMD_SET_STATE_OF_CHANNELS:
          {
            ...
            request.channel_states.data = (uint8_t *)((uint8_t *)&request + (uint16_t)request.channel_states.data);
        ...
        case CMD_CHANNEL_COUNT:
          {
            /* Cast buffer as request. */
    
    
            ChannelCountResponse response;
            ...
            /* Copy result to output buffer. */
            /* Cast start of buffer as reference of result type and assign result. */
            ChannelCountResponse &output = *(reinterpret_cast
        ...
        case CMD_ON_STATE_VOLTAGE_CHANGED:
          {
            ...
            response.result =
            obj_.on_state_voltage_changed(request.original_value, request.new_value);
        ...
        case CMD_ON_STATE_FREQUENCY_CHANGED:
          {
            ...
            response.result =
            obj_.on_state_frequency_changed(request.new_value);
