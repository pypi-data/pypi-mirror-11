...
------
 ...
 - changed .cliqrc to CONFIG.txt due to issue with packaging hidden files


0.5.10
------

 - added requests to install_requires list in setup.py

0.5.9
------

 - removed check_config() and .cliqrc file creation and just added .cliqrc to MANIFEST.in
