...
#       $Id: __init__.py,v 1.3 2015/09/29 07:59:13 dieter Exp $
'''Advanced Query
...
if CatalogTool:
  ...
  try:
    ...
    # `Products.CMFCore >= 2.3`
    from AccessControl import getSecurityManager
    def _getAuthenticatedUser(unused): return getSecurityManager().getUser()

  from Products.CMFCore.CatalogTool import _checkPermission, AccessInactivePortalContent
