...
class Api(_CommonAPIClass):
	...
	class _Users(_CommonAPIClass):
		...
		class _Imports(_CommonAPIClass):
			...
			def Import(self, Appliancename, Applianceversion, Imported, Force, Usemajor=None, body=None):
				kwargs = {'applianceName': Appliancename, 'applianceVersion': Applianceversion, 'imported': Imported, 'force': Force, 'useMajor': Usemajor}
