...
__all__ = ['RunUnitTests','RunTestKL1D','RunTestKL2D','RunTestRandomSampling','RunTestTimingPreFit','RunTestCutANOVA']
...
def RunTestCutANOVA(maxprocs=None,PLOTTING=False):
    import TestCutANOVA
    TestCutANOVA.run(maxprocs,PLOTTING)
...
def RunUnitTests(maxprocs=None,PLOTTING=False):
    ...
    RunTestCutANOVA(maxprocs,PLOTTING)
