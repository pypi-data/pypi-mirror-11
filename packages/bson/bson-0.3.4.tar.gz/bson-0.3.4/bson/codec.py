...
def encode_double_element(name, value):
    try:
        ...
        return "\x01" + encode_cstring(name) + encode_double(value).decode("utf-8")
...
def encode_string_element(name, value):
    try:
        ...
        return "\x02" + encode_cstring(name) + encode_string(value).decode("utf-8")
...
def encode_int32_element(name, value):
    try:
        ...
        return "\x10" + encode_cstring(name) + struct.pack("<i", value).decode("utf-8")
