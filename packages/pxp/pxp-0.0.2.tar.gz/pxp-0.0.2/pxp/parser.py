"""This code was generated by pyebnf."""
...
class TokenType(Enum):
  """This Enum represents all the types of tokens that are generated by the Parser."""
  program = 1
  statement = 2
  assignment = 3
  variable = 4
