...
def to_number(resolver, value):
  """Returns the number representation of the string value. This is an unchecked conversion, so if
  the string is not a valid number an exception will be thrown.
  """
