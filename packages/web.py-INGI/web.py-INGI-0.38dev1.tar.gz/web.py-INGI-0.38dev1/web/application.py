...
class application:
    ...
    def init_mapping(self, mapping):
        if isinstance(mapping, tuple):
            ...
            self.mapping = list(mapping.iteritems())
    ...
    def add_mapping(self, pattern, classname):
        warnings.warn("add_mapping is deprecated, use add_to_mapping instead", DeprecationWarning)
        self.add_to_mapping(pattern, classname)

    def add_to_mapping(self, pattern, classname):
