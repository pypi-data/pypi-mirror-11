...
class PypyFakeSocket(object):
    """ Fake object that implements _drop and _reuse as Pypy needs for objects used in socket._fileobject """
    def _reuse(self):
        pass
    def _drop(self):
        pass
_fileobject_uses_str_type = isinstance(socket._fileobject(PypyFakeSocket())._rbuf, basestring)
...
class HTTPServer(object):
    ...
    def tick(self):
        ...
        try:
            ...
            conn = self.ConnectionClass(self, s._sock, makefile)
