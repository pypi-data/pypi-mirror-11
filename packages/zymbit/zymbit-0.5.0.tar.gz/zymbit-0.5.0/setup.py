...
setup(name='zymbit',
      ...
      packages=['zymbit', 'zymbit.arduino', 'zymbit.commands', 'zymbit.compat', 'zymbit.darwin', 'zymbit.linux', 'zymbit.messenger', 'zymbit.raspberrypi'],
      scripts=['scripts/emit.py', 'scripts/zymbit'],
