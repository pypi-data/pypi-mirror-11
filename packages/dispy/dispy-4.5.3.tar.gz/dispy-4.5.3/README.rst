...
* dispy is implemented with `asyncoro
  ...
  to get the results, asyncoro can be used to execute distributed
...
is automatically installed if dispy is installed with pip. Under
Windows efficient polling notifier I/O Completion Ports (IOCP) is
