...
class baseAttrs2(baseAttrs):
    ...
    def __init__(self, pos = (0.,0.,0.), x = 0., y = 0., z = 0., axis = (1.,0.,0.), size = (1.,1.,1.), visible = True,
                 ...
                 opacity = 1.0, **kwargs):
        super(baseAttrs2, self).__init__(pos=pos,axis=axis,size=size,up=up,color=color,red=red,green=green,blue=blue,x=x,y=y,z=z,frame=frame,display=display,visible=visible,**kwargs)
...
class trailAttrs(baseAttrs2):
    ...
    def __init__(self, pos = (0.,0.,0.), x = 0., y = 0., z = 0., axis = (1.,0.,0.), size = (1.,1.,1.), visible = True,
        ...
        super(trailAttrs, self).__init__(pos=pos,axis=axis,size=size,up=up,color=color,red=red,green=green,blue=blue,x=x,y=y,z=z,frame=frame,display=display,visible=visible,**kwargs)
...
class helix(baseAttrs2):
    ...
    def __init__(self, pos = (0.,0.,0.), x = 0., y = 0., z = 0., axis = (1.,0.,0.), length = -1., radius = 1., thickness = 0., coils = 5,
        ...
        super(helix, self).__init__(pos=pos, x=x, y=y, z=z, axis=axis, size=size, up=up,color=color,red=red,green=green,blue=blue,
                                   material=material,frame=frame,display=display,visible=visible,**kwargs)
        object.__getattribute__(self, 'size').remove_notification((self.addattr,'size'))
        object.__setattr__(self, 'length', length)
        object.__setattr__(self, 'radius', radius)
...
class ring(baseAttrs):
    ...
    def __init__(self, pos = (0.,0.,0.), x = 0., y = 0., z = 0., axis = (1.,0.,0.),
        ...
        super(ring, self).__init__(pos=pos, x=x, y=y, z=z, axis=axis, size=size, up=up,color=color,red=red,green=green,blue=blue,frame=frame,display=display,visible=visible,**kwargs)
        object.__setattr__(self, 'length', length)
        object.__setattr__(self, 'radius', radius)
        object.__setattr__(self, 'thickness', thickness)
        object.__setattr__(self, 'make_trail', make_trail )
...
class label(baseAttrs2):
    ...
    def __init__(self, pos = (0.,0.,0.), x = 0., y = 0., z = 0., color = (1.,1.,1.), red = 1., green = 1., blue = 1., opacity = 0.66, 
        ...
        super(label, self).__init__(pos=pos, x=x, y=y, z=z, color=color, red=red, green=green,blue=blue, opacity=opacity, frame=frame, display=display,visible=visible,**kwargs)
...
class frame(baseAttrs):
    ...
    def __init__(self, pos = (0.,0.,0.), x = 0., y = 0., z = 0., axis = (1.,0.,0.), display = None, visible = True,
        ...
        super(frame, self).__init__(pos=pos, x=x, y=y, z=z, axis=axis, up=up, color=color, red=red, green=green, blue=blue, display=display,visible=visible,**kwargs)
