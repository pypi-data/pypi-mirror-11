...
from gipsy.modeltranslation.sections import __version__ as version
from gipsy.modeltranslation.sections import __doc__ as description
...
setup(
    ...
    url='http://github.com/revsquare/gipsy-modeltranslation-sections',
    packages=['gipsy'],
