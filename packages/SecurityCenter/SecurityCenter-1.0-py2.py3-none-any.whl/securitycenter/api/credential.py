...
class Credential(Module):
    ...
    def _edit(self, type, id, simulate=True, name=None, description=None, tag=None, **kwargs):
        try:
    ...
    def edit_windows(self, id, simulate=True, name=None, description=None, tag=None, username=None, password=None, domain=None):
        return self._edit(
            'windows', id, simulate=simulate,
            name=name, description=description, tag=tag,
            username=username, password=password, domain=domain
        )

    def edit_ssh(self, id, simulate=True, name=None, description=None, tag=None, username=None, password=None, public_key=None, private_key=None, passphrase=None, escalation=None, escalation_username=None, escalation_password=None):
        if public_key is not None:
            public_key = self._sc.file.name_or_upload(public_key)
    ...
    def edit_snmp(self, id, simulate=True, name=None, description=None, tag=None, community=None):
        return self._edit(
            'snmp', id, simulate=simulate,
            name=name, description=description, tag=tag,
            communityString=community
        )

    def edit_kerberos(self, id, simulate=True, name=None, description=None, tag=None, ip=None, port=None, protocol=None, realm=None):
        return self._edit(
            'kerberos', id, simulate=simulate,
            name=name, description=description, tag=tag,
            ip=ip, port=port, protocol=protocol, realm=realm
        )

    def edit_database(self, id, simulate=True, name=None, description=None, tag=None, login=None, password=None, db_type=None, sid=None, port=None, oracle_auth_type=None, sql_server_auth_type=None):
        return self._edit(
            'database', id, simulate=simulate,
            name=name, description=description, tag=tag,
            login=login, password=password, dbType=db_type, sid=sid, port=port,
            OracleAuthType=oracle_auth_type, SQLServerAuthType=sql_server_auth_type
        )
