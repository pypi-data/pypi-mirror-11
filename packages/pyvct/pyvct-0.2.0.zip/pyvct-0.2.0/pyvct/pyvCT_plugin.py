...
class PyvCT_plugin(AFXForm):
    ...
    def __init__(self, owner):
        ...
        # Keyword definitions
        self.cmd                 = AFXGuiCommand(mode=self, method='createVirtualCT',objectName='virtualCTs', registerQuery=False)
...
desc = 'An ABAQUS plugin used to generate a virtual CT from the output of a bone remodelling analysis.\n\n'                  + \
...
toolset.registerGuiMenuButton(
    buttonText='pyvCT|Create a virtual CT', 
    object=PyvCT_plugin(toolset),
    messageId=AFXMode.ID_ACTIVATE,
    icon=None,
    kernelInitString='import virtualCTs',
    applicableModules=ALL,
    version=__version__,
    author='Michael Hogg',
    description=desc,
    helpUrl='https://github.com/mhogg/pyvct'
)
