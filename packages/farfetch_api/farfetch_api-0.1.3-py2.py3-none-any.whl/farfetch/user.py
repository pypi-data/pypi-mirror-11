...
class UserApi(object):
    ...
    def password_reset_user(self, username, token, password):
    ...
    def change_password_user(self, id, username, old_password, new_password):
    ...
    def addresses_user(self, user_id, type = None, page = None, page_size = None):
    ...
    def billing_addresses_user(self, user_id, page = None, page_size = None):
        return self.addresses_user(
            user_id,
            type = "Billing",
            page = page,
            page_size = page_size
    ...
    def shipping_addresses_user(self, user_id, page = None, page_size = None):
        return self.addresses_user(
            user_id,
            type = "Shipping",
            page = page,
    ...
    def update_default_address_user(self, user_id, address_id, address_type):
        url = self.base_url + "users/%s/addresses/default/%s" % (user_id, address_id)
        params = dict(
            type = address_type
        )
        contents = self.put(url, params = params, data_j = dict())
        return contents
    ...
    def payments_user(self, user_id, page = None, page_size = None):
