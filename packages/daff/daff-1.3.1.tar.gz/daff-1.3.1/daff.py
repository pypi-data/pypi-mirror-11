...
class Coopy(object):
	...
	def coopyhx(self,io):
		...
		if (cmd1 == "git"):
			...
			if (pos22 < 0):
				pos22 = 0
			res22 = args[pos22:(pos22 + len)]
			del args[pos22:(pos22 + len)]
			types = res22
		...
		if git:
			...
			if (pos23 < 0):
				pos23 = 0
			res23 = args[pos23:(pos23 + ct)]
			del args[pos23:(pos23 + ct)]
			git_args = res23
			...
			if (pos24 < 0):
				pos24 = 0
			res24 = args[pos24:(pos24 + len1)]
			del args[pos24:(pos24 + len1)]
			res24
			offset = 0
	...
	def show(t):
		...
		while ((_g < h)):
			...
			while ((_g1 < w)):
				...
				txt = (HxOverrides.stringOrNull(txt) + " ")
			txt = (HxOverrides.stringOrNull(txt) + "\n")
		haxe_Log.trace(txt,_hx_AnonObject({'fileName': "Coopy.hx", 'lineNumber': 931, 'className': "Coopy", 'methodName': "show"}))
