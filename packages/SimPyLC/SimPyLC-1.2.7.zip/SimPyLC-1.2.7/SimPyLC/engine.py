...
class _Functor:
	...
	def __div__ (self, other):
		return float (self ()) / _evaluate (other)
		
	def __rdiv__ (self, other):
		return float (_evaluate (other)) / self ()
	...
	def __bool__ (self):	# Only needed for Python 3.x
		return __nonzero___ (self)
