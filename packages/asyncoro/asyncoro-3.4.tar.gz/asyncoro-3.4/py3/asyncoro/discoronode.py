...
def discoro_proc(_discoro_name):
    # coroutine
...
def _discoro_process(_discoro_config, _discoro_queue):
    ...
    _discoro_queue.put(asyncoro.serialize(asyncoro.Coro(discoro_proc, _discoro_config['name'])))
...
if __name__ == '__main__':
    ...
    _discoro_config['name'] = _discoro_name + '-%s' % _discoro_proc_id
    _discoro_scheduler = asyncoro.AsynCoro(**_discoro_config)
    _discoro_coro = asyncoro.Coro(discoro_proc, _discoro_config['name'])
