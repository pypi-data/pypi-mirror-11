...
class NGFWInterfaceID(model_base.BASEV2):
    router_id = sa.Column(
        sa.String(36),
...
class RouterPort2NGFWPort(model_base.BASEV2):
    ngfw_port = sa.Column(
        sa.String(36),
...
#   supported_extension_aliases = ["router", "ext-gw-mode"]
    ...
    def _generate_ngfw_interface_id(self, context, router_id):
        with context.session.begin(subtransactions=True):
            qry = context.session.query(NGFWInterfaceID)
    ...
    def create_router(self, context, router):
        ...
        try:        
            ...
            routerport2ngfwport = RouterPort2NGFWPort(router_port=0, # TODO!?
        ...
        try:
            with context.session.begin(subtransactions=True):
                ...
                interface_id = 1
                router_entry = NGFWInterfaceID(router_id=router_id,
        ...
        if router_dict[l3.EXTERNAL_GW_INFO]:
            ...
            try:
                ...
                with context.session.begin(subtransactions=True):
                    routerport2ngfwport = RouterPort2NGFWPort(router_port=gw_port_id,
    ...
    def update_router(self, context, router_id, router):
        ...
        if r['gw_port_id']:
            ...
            qry = context.session.query(RouterPort2NGFWPort)
    ...
    def delete_router(self, context, router_id):
        ...
        # TODO: remove ngfwinterfaceids table entry
    ...
    def add_router_interface(self, context, router_id, interface_info):
        ...
        with context.session.begin(subtransactions=True):
            routerport2ngfwport = RouterPort2NGFWPort(
