# -*- coding: iso-8859-1 -*-
# Copyright (C) 2009-2015 Marcus Priesch, All rights reserved
...
#    28-Sep-2015 (MPR) Allow to turn off libcapi caching
#    ««revision-date»»···
#--
import libcapi
import re
...
class Connection (Sensor) :
    ...
    def __init__ (self, port, capi_caching = True) :
        capi = libcapi.CAPI (cached = capi_caching)
        capi.init (port)
