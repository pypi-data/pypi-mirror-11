...
class Report(object):
    ...
    def create_suite(self, props, timestamp, module):
        ...
        return TestSuite(props['name'], test_cases=test_cases, timestamp=timestamp, package=module)

    def create_case(self, props):
        test_case = TestCase(classname=props['className'], elapsed_sec=props['duration'], name=props['name'].decode('ascii', 'ignore'))
