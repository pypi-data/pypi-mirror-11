...
class Report(object):
    ...
    def get_report(self, job_url_in, build_number=None):
        job_url = self.fix_url(job_url_in)
        print("fixed job url: " + str(job_url))
    ...
    def fix_url(self, url):
        ...
        return urlparse.urlunparse(
            urlparse.ParseResult(data.scheme, data.netloc, os.path.realpath(data.path), data.params,
