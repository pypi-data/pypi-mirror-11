...
class Connection(object):
    ...
    def __init__(self, server, *args, **kwargs):
        """
        Initializes connection to the Shooju API.  Must use either user+api_key or email+google_oauth_token to authenticate.
    ...
    def get_points(self, series_id, date_start=None, date_finish=None, size=10,
                   snapshot_job_id=None, snapshot_date=None):
        """
...
class ShoojuApi(object):
    ...
    def get_series(self, series_id, date_start=None, date_finish=None,
                   size=10, fields=None, snapshot_job_id=None, snapshot_date=None):
        """
        Retrieves series
...
class Client(object):
    ...
    def _call(self, path=None, **kwargs):
        ...
        r = method(url, params=kwargs.get('params'), data=payload, headers=headers, files=files, auth=(self._user, self._password))
