...
$Id: moogvcf-rt.py 914 2015-08-16 23:45:09Z weegreenblobbie $
...
def worker(q, disp_q, signal, sig_dur, t):
...
running, you will get undefined behavior""")
    ...
    p = multiprocessing.Process(
        target=worker, args = (q, disp_q, signal[0], signal.getDuration(), t))
    p.start()
