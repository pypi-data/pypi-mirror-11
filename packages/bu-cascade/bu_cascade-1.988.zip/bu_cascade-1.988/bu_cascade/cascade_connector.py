...
# from bu_cascade.dynamic_data_def_builder.fetcher import fetch_array
...
class Cascade(object):
    ...
    def submit_part_b(self, form_data, submit_new):
        if self.dynamo:
            self.dynamo.submit_form(form_data, submit_new)
            return True
        else:
            print "Can't submit until dynamo is instantiated."
            return False
