...
# TODO: re-implement Ajax calls to fetch without Flask
# TODO: re-add parameters
# TODO: implement loading screen while file permissions crunches
# TODO: return success page through the chain back to the page via AJAX
# TODO: metadata? (later)
...
class DataDefinitionBuilder:
    def __init__(self, my_cascade, users_username):
        ...
        self.user_name = users_username  # Passed on to fetcher.py by being dynamically built into the HTML/JS
        ...
        self.my_form = """
<div>
    <link rel="stylesheet" type="text/css" href="../static/dynamic_style.css"/>
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.js"></script>
    <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js"></script>
    <script src="../static/dynamic_scripts.js"></script>
                    ...
                    self.my_form += """<label for="%(0)s">%(3)s%(5)s</label><br/>\n%(4)s<input type="button" id="%(0)s" value="%(1)s" onclick="%(2)s" %(6)s/><br/>\n""" \
                                    % {'0': prefix + identifier,
                                       ...
                                       '2': "fetchArrayFromCascade('','" +
                                            structure[i][1][
                                                'type'] + "','" + prefix + identifier + "','" + self.user_name + "');",
                                       '3': label,
                                       '4': indent,
                                       '5': required_text,
                                       '6': parameters}
...
%(1)s</script>\n""" % {'0': id_to_work_with, '1': indent}
    ...
    def submit_thineself(self, form_contents):
        # data = [(elem.split("=", 1)[0], elem.split("=", 1)[1]) for elem in form_contents.split("`")]

        raw_data = [("group_program", "Program"),
("program_code", "asdfa"),
("program_description", "<p>Through Bethel&rsquo;s business management program, you&rsquo;ll learn about economics, marketing, business ethics, and more that will allow you to compete in today&rsquo;s workplace.</p><p>Explore our concentrations to learn more details about the program that will take your career to the next level.</p>"),
("group_close", "Ignore this"),
("group_concentration", "Concentration"),
("concentration_code", "2-BS-B-GBUS"),
("concentration_description", "<p>The Global Business concentration will help you understand global business management and apply principles of globalization to your work. Plus you&rsquo;ll have the opportunity to <a href=\"/graduate/academics/mba/travel-experience\">travel internationally</a>&nbsp;to meet business executives across several industries.</p>"),
("asset_p_concentration_page", "adult-undergrad/academics/business-management/program-details/global-business"),
("total_credits", "49"),
("program_length", "22 months"),
("group_courses", "Courses"),
("course_heading", "course heading1"),
("course_numbers", "<p>course nums 1</p>"),
("group_close", "Ignore this"),
("group_courses", "Courses"),
("course_heading", "course heading2"),
("course_numbers", "<p>course nums 2</p>"),
("group_close", "Ignore this"),
("group_concentration_banner", "Banner info"),
("concentration_name", "Business Management, B.S.: Global Business Concentration"),
("cost", "$485"),
("group_cohort_details", "Cohort details"),
("semester_start", "Fall"),
("year_start", "2015"),
("delivery_label", "Online"),
("delivery_description", "You'll complete 100% of your coursework online."),
("location", "Arden Hills"),
("group_close", "Ignore this"),
("group_cohort_details", "Cohort details"),
("semester_start", "Spring"),
("year_start", "2016"),
("delivery_label", "Face to Face"),
("delivery_description", "You'll meet for classes at one of our convenient locations."),
...
("year_start", "2016"),
("delivery_label", "Online"),
("delivery_description", "You'll complete over 80% of your coursework online."),
("location", "Arden Hills"),
("group_close", "Ignore this"),
("group_cohort_details", "Cohort details"),
("semester_start", "Fall"),
...
("group_close", "Ignore this"),
("group_concentration", "Concentration"),
("concentration_code", "2-BS-B-HRMA"),
("concentration_description", "<p>With a Human Resources Management concentration, you&rsquo;ll develop the skills and knowledge most needed by human resource managers, analysts, and generalists. You&rsquo;ll learn the details of benefits, compensation, employment law, talent management, and more.</p>"),
("asset_p_concentration_page", "adult-undergrad/academics/business-management/program-details/human-resources-management"),
("total_credits", "49"),
("program_length", "22 months"),
("group_courses", "Courses"),
("course_heading", ""),
...
("group_close", "Ignore this"),
("group_concentration_banner", "Banner info"),
("concentration_name", "Business Management, B.S.: Human Resources Mgmt Conc"),
("cost", "$485"),
("group_cohort_details", "Cohort details"),
("semester_start", "Fall"),
("year_start", "2015"),
...
("group_close", "Ignore this"),
("group_concentration", "Concentration"),
("concentration_code", "2-BS-B-MGMT"),
("concentration_description", "<p>With a Management concentration, you&rsquo;ll build a strong foundation in management skills, such as strategic planning, project management, and operations.</p>"),
("asset_p_concentration_page", "adult-undergrad/academics/business-management/program-details/management"),
("total_credits", "49"),
("program_length", "22 months"),
("group_courses", "Courses"),
("course_heading", ""),
...
("group_close", "Ignore this"),
("group_concentration_banner", "Banner info"),
("concentration_name", "Business Management, B.S.: Management Concentration"),
("cost", "$485"),
("group_cohort_details", "Cohort details"),
("semester_start", "Spring"),
("year_start", "2016"),
...
("group_close", "Ignore this")]
        print "--------------------------------"
        data_structure = self.recursively_create_structure_for_data_nodes(raw_data)
        # self.pretty_print(foo)
    ...
    def alias_fetch_array(self, username, called):
        return fetch_array(username, called)
