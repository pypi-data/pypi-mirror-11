...
def plot_argparser():
    ...
    plotargs.add_argument('--capthick', type=float, default=None,
                          ...
                          '(default: %(default)s)')
    plotargs.add_argument('--colors', default=None, nargs='+',
                          help='either an integer for the number of colors '
                          'or a list of colors '
                          '(default: %(default)s)')
    plotargs.add_argument('--color-sequence', default=None, nargs='+',
                          help='list of colors '
                          '(default: %(default)s)')
    ...
    plotargs.add_argument('--fig-ref-fontsize-change', type=float, default=3,
                          help='additive constant to change fig reference '
                          'letter font size (default: %(default)s)')
    ...
    plotargs.add_argument('--subplots-adjust-wspace', type=float, default=0,
                          help='amount of width adjustment in subplots grid '
                          '(default: %(default)s)')
    plotargs.add_argument('--subplots-adjust-hspace', type=float, default=0,
                          help='amount of height adjustment in subplots grid '
                          '(default: %(default)s)')
    ...
    plotargs.add_argument('--plotlabel', default=None,
                          ...
                          '(default: %(default)s).')
    plotargs.add_argument('--plotlabels', default=None, nargs='+',
                          help='list of custom plot legend labels for each '
                          'set of plotted data '
                          '(default: %(default)s).')
    ...
    plotargs.add_argument('--left-limit-scale-factor', type=float,
                          default=1, help='``--left-limit`` '
                          'scale-factor (default: %(default)s)')
    plotargs.add_argument('--left-limit-shift', type=float,
                          default=0, help='shift the ``--left-limit`` '
                          'by constant (default: %(default)s)')
    ...
    plotargs.add_argument('--right-limit-scale-factor', type=float,
                          default=1, help='``--right-limit`` '
                          'scale-factor (default: %(default)s)')
    plotargs.add_argument('--right-limit-shift', type=float,
                          default=0, help='shift the ``--right-limit`` '
                          'by constant (default: %(default)s)')
    ...
    plotargs.add_argument('--bottom-limit-scale-factor', type=float,
                          default=1, help='``--bottom-limit`` '
                          'scale-factor (default: %(default)s)')
    plotargs.add_argument('--bottom-limit-shift', type=float,
                          default=0, help='shift the ``--bottom-limit`` '
                          'by constant (default: %(default)s)')
    ...
    plotargs.add_argument('--top-limit-scale-factor', type=float,
                          default=1, help='``--top-limit`` '
                          'scale-factor (default: %(default)s)')
    plotargs.add_argument('--top-limit-shift', type=float,
                          default=0, help='shift the ``--top-limit`` '
                          'by constant (default: %(default)s)')
...
def cmap_argparser():
    ...
    parser.add_argument('--fig-ref-fontsize-change', type=float, default=3,
                        help='additive constant to change fig reference '
                        'letter font size (default: %(default)s)')
