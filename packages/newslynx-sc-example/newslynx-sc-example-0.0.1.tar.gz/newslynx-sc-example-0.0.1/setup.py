...
# setup
setup(
    name='newslynx-sc-example',
    version=VERSION,
    description='An example Sous Chef module generated by ',
    ...
    author='Merlynne',
    author_email='',
    url='http://github.com/newslynx/newslynx-sc-example',
    license='MIT',
    packages=find_packages(exclude=['ez_setup', 'examples', 'tests']),
    namespace_packages=[],
    package_data={"newslynx_sc_example": ['*.yaml']},
