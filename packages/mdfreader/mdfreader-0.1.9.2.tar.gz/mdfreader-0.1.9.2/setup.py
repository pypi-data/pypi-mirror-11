...
setup(
    ...
    # data_files=[('my_data',. You can download it from pypi or look for the latest git. ['data/data_file'])],
    ...
    ext_modules=cythonize(Extension('dataRead', ['mdfreader/dataRead.c'], include_dirs=[get_include()]))
)
