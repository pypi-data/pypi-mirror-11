...
class Generator(object):
    ...
    def generate(self, recent_articles, settings):
        """
        Generates the site
        :param recent_articles:
        :param settings:
        :return:
        """
        ...
        try:
            ...
            return {
                'status': False,
                'data': "I/O Error: " + format(err.errno, err.strerror)
            }
        else:
            file_out.close()
