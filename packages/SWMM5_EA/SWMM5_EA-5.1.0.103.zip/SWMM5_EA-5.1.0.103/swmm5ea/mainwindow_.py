...
#
# Created: Wed Aug 12 19:33:20 2015
...
class Ui_SWMM5EA(object):
    ...
    def retranslateUi(self, SWMM5EA):
        SWMM5EA.setWindowTitle(_translate("SWMM5EA", "SWMM5 EA", None))
        self.menu_File.setTitle(_translate("SWMM5EA", "&Project", None))
        self.menu_File_2.setTitle(_translate("SWMM5EA", "&File", None))
        self.menuOptimization.setTitle(_translate("SWMM5EA", "Optimization", None))
        self.menuHelp.setTitle(_translate("SWMM5EA", "Help", None))
        self.menuView.setTitle(_translate("SWMM5EA", "View", None))
        self.Main_toolbar.setWindowTitle(_translate("SWMM5EA", "Main toolbar", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.textEdit_tab), _translate("SWMM5EA", "Output", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.textEdit_2_tab), _translate("SWMM5EA", "Errors and Warnings", None))
        self.action_Insert_Slots.setText(_translate("SWMM5EA", "&Insert Slots", None))
        self.action_Load_SWMM_File.setText(_translate("SWMM5EA", "&Load SWMM File", None))
        self.action_EditProject.setText(_translate("SWMM5EA", "&Edit", None))
        self.action_EditProject.setToolTip(_translate("SWMM5EA", "Edit Project", None))
        self.actionSave_As.setText(_translate("SWMM5EA", "Save &As", None))
        self.action_SaveProject.setText(_translate("SWMM5EA", "&Save Project", None))
        self.action_NewProject.setText(_translate("SWMM5EA", "&New Project", None))
        self.action_OpenProject.setText(_translate("SWMM5EA", "Open Project", None))
        self.action_OpenProject.setToolTip(_translate("SWMM5EA", "Open a saved project", None))
        self.actionRun_Optimization.setText(_translate("SWMM5EA", "Run Optimization", None))
        self.actionRun_Optimization.setToolTip(_translate("SWMM5EA", "Start optimization run", None))
        self.actionPause_Optimization.setText(_translate("SWMM5EA", "Pause Optimization", None))
        self.actionPause_Optimization.setToolTip(_translate("SWMM5EA", "Pause at the end of this generation", None))
        self.actionStop_Optimization.setText(_translate("SWMM5EA", "Stop Optimization", None))
        self.actionStop_Optimization.setToolTip(_translate("SWMM5EA", "Completely stop the Optimization", None))
        self.actionHelp_About.setText(_translate("SWMM5EA", "&About", None))
        self.actionHelp_About.setToolTip(_translate("SWMM5EA", "About", None))
        self.actionHelp_Users_Guide.setText(_translate("SWMM5EA", "&Users\' Guide", None))
        self.actionHelp_Users_Guide.setToolTip(_translate("SWMM5EA", "Users\' Guide", None))
        self.actionInitialize_model.setText(_translate("SWMM5EA", "Initialize the optimization", None))
        self.actionInitialize_model.setToolTip(_translate("SWMM5EA", "Initialize the optimization", None))
        self.actionExit.setText(_translate("SWMM5EA", "Exit", None))
        self.actionExit.setToolTip(_translate("SWMM5EA", "Exit SWMM5 EA", None))
        self.action_Zoom_Extent.setText(_translate("SWMM5EA", "&Zoom Extent", None))
        self.action_Zoom_Extent.setToolTip(_translate("SWMM5EA", "Zoom the graph to the data extent", None))
