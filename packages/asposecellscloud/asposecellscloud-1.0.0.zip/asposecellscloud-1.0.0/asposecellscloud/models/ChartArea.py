...
class ChartArea(object):
    ...
    def __init__(self):
        ...
        self.attributeMap = {
            'Area': 'Area','AutoScaleFont': 'AutoScaleFont','BackgroundMode': 'BackgroundMode','Border': 'Border','Font': 'Font','IsAutomaticSize': 'IsAutomaticSize','IsInnerMode': 'IsInnerMode','Shadow': 'Shadow','ShapeProperties': 'ShapeProperties','Width': 'Width','Height': 'Height','X': 'X','Y': 'Y','link': 'link'}       
