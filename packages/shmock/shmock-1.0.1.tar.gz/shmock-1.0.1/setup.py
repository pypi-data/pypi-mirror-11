...
if __name__ == '__main__':
    setup(
          ...
          long_description = '''SHell command MOCK (SHMOCK)
===========================
...
''',
          ...
          packages = ['shmock'],
          py_modules = [],
          classifiers = ['Programming Language :: Python', 'Programming Language :: Python :: 2', 'Programming Language :: Python :: 2.6', 'Programming Language :: Python :: 2.7', 'Programming Language :: Python :: 3'],
          entry_points={
          'console_scripts':
              []
          },
