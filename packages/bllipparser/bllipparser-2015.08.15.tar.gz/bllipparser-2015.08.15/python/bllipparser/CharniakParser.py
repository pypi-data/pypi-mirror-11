...
class ParserError:
    ...
    __swig_setmethods__["description"] = _CharniakParser.ParserError_description_set
    __swig_getmethods__["description"] = _CharniakParser.ParserError_description_get
...
class LabeledSpans:
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["minSizeForParsing"] = _CharniakParser.LabeledSpans_minSizeForParsing_set
    __swig_getmethods__["minSizeForParsing"] = _CharniakParser.LabeledSpans_minSizeForParsing_get
    __swig_setmethods__["sorted"] = _CharniakParser.LabeledSpans_sorted_set
    __swig_getmethods__["sorted"] = _CharniakParser.LabeledSpans_sorted_get
    def __init__(self): 
        this = _CharniakParser.new_LabeledSpans()
        try: self.this.append(this)
        except: self.this = this
    def addConstraint(self, *args): return _CharniakParser.LabeledSpans_addConstraint(self, *args)
    __swig_getmethods__["spansFromTree"] = lambda x: _CharniakParser.LabeledSpans_spansFromTree
    def ensureSorted(self): return _CharniakParser.LabeledSpans_ensureSorted(self)
    def matches(self, *args): return _CharniakParser.LabeledSpans_matches(self, *args)
    def applyToChart(self, *args): return _CharniakParser.LabeledSpans_applyToChart(self, *args)
    def disrupts(self, *args): return _CharniakParser.LabeledSpans_disrupts(self, *args)
...
def LabeledSpans_spansFromTree(*args):
  return _CharniakParser.LabeledSpans_spansFromTree(*args)
LabeledSpans_spansFromTree = _CharniakParser.LabeledSpans_spansFromTree
...
def loadTermsOnly(*args):
  return _CharniakParser.loadTermsOnly(*args)
loadTermsOnly = _CharniakParser.loadTermsOnly

def loadHeadInfoOnly(*args):
  return _CharniakParser.loadHeadInfoOnly(*args)
loadHeadInfoOnly = _CharniakParser.loadHeadInfoOnly
...
class ScoredSpan:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ScoredSpan, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ScoredSpan, name)
    __repr__ = _swig_repr
    __swig_setmethods__["termIndices"] = _CharniakParser.ScoredSpan_termIndices_set
    __swig_getmethods__["termIndices"] = _CharniakParser.ScoredSpan_termIndices_get
    __swig_setmethods__["score"] = _CharniakParser.ScoredSpan_score_set
    __swig_getmethods__["score"] = _CharniakParser.ScoredSpan_score_get
    def __init__(self): 
        this = _CharniakParser.new_ScoredSpan()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _CharniakParser.delete_ScoredSpan
    __del__ = lambda self : None;
ScoredSpan_swigregister = _CharniakParser.ScoredSpan_swigregister
ScoredSpan_swigregister(ScoredSpan)
...
class Node:
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["start"] = _CharniakParser.Node_start_set
    __swig_getmethods__["start"] = _CharniakParser.Node_start_get
    __swig_setmethods__["end"] = _CharniakParser.Node_end_set
    __swig_getmethods__["end"] = _CharniakParser.Node_end_get
    __swig_setmethods__["termIndices"] = _CharniakParser.Node_termIndices_set
    __swig_getmethods__["termIndices"] = _CharniakParser.Node_termIndices_get
    __swig_setmethods__["score"] = _CharniakParser.Node_score_set
    __swig_getmethods__["score"] = _CharniakParser.Node_score_get
    __swig_setmethods__["leftChild"] = _CharniakParser.Node_leftChild_set
    __swig_getmethods__["leftChild"] = _CharniakParser.Node_leftChild_get
    __swig_setmethods__["rightChild"] = _CharniakParser.Node_rightChild_set
    __swig_getmethods__["rightChild"] = _CharniakParser.Node_rightChild_get
    def __init__(self, *args): 
        this = _CharniakParser.new_Node(*args)
        try: self.this.append(this)
        except: self.this = this
    def termNames(self): return _CharniakParser.Node_termNames(self)
    __swig_destroy__ = _CharniakParser.delete_Node
    __del__ = lambda self : None;
Node_swigregister = _CharniakParser.Node_swigregister
Node_swigregister(Node)

class SimpleChart:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SimpleChart, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SimpleChart, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _CharniakParser.new_SimpleChart(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _CharniakParser.delete_SimpleChart
    __del__ = lambda self : None;
    def populate(self, *args): return _CharniakParser.SimpleChart_populate(self, *args)
    def prunePreterms(self, *args): return _CharniakParser.SimpleChart_prunePreterms(self, *args)
    def pruneConstituents(self, *args): return _CharniakParser.SimpleChart_pruneConstituents(self, *args)
    def prune(self, *args): return _CharniakParser.SimpleChart_prune(self, *args)
    def initChart(self): return _CharniakParser.SimpleChart_initChart(self)
    def fillChart(self): return _CharniakParser.SimpleChart_fillChart(self)
    def addChildTrees(self, *args): return _CharniakParser.SimpleChart_addChildTrees(self, *args)
    def makeTrees(self, *args): return _CharniakParser.SimpleChart_makeTrees(self, *args)
    def parse(self): return _CharniakParser.SimpleChart_parse(self)
SimpleChart_swigregister = _CharniakParser.SimpleChart_swigregister
SimpleChart_swigregister(SimpleChart)
...
class VectorLabeledSpan:
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, VectorLabeledSpan, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, VectorLabeledSpan, name)
    __repr__ = _swig_repr
    def iterator(self): return _CharniakParser.VectorLabeledSpan_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _CharniakParser.VectorLabeledSpan___nonzero__(self)
    def __bool__(self): return _CharniakParser.VectorLabeledSpan___bool__(self)
    def __len__(self): return _CharniakParser.VectorLabeledSpan___len__(self)
    def pop(self): return _CharniakParser.VectorLabeledSpan_pop(self)
    def __getslice__(self, *args): return _CharniakParser.VectorLabeledSpan___getslice__(self, *args)
    def __setslice__(self, *args): return _CharniakParser.VectorLabeledSpan___setslice__(self, *args)
    def __delslice__(self, *args): return _CharniakParser.VectorLabeledSpan___delslice__(self, *args)
    def __delitem__(self, *args): return _CharniakParser.VectorLabeledSpan___delitem__(self, *args)
    def __getitem__(self, *args): return _CharniakParser.VectorLabeledSpan___getitem__(self, *args)
    def __setitem__(self, *args): return _CharniakParser.VectorLabeledSpan___setitem__(self, *args)
    def append(self, *args): return _CharniakParser.VectorLabeledSpan_append(self, *args)
    def empty(self): return _CharniakParser.VectorLabeledSpan_empty(self)
    def size(self): return _CharniakParser.VectorLabeledSpan_size(self)
    def clear(self): return _CharniakParser.VectorLabeledSpan_clear(self)
    def swap(self, *args): return _CharniakParser.VectorLabeledSpan_swap(self, *args)
    def get_allocator(self): return _CharniakParser.VectorLabeledSpan_get_allocator(self)
    def begin(self): return _CharniakParser.VectorLabeledSpan_begin(self)
    def end(self): return _CharniakParser.VectorLabeledSpan_end(self)
    def rbegin(self): return _CharniakParser.VectorLabeledSpan_rbegin(self)
    def rend(self): return _CharniakParser.VectorLabeledSpan_rend(self)
    def pop_back(self): return _CharniakParser.VectorLabeledSpan_pop_back(self)
    def erase(self, *args): return _CharniakParser.VectorLabeledSpan_erase(self, *args)
    def __init__(self, *args): 
        this = _CharniakParser.new_VectorLabeledSpan(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _CharniakParser.VectorLabeledSpan_push_back(self, *args)
    def front(self): return _CharniakParser.VectorLabeledSpan_front(self)
    def back(self): return _CharniakParser.VectorLabeledSpan_back(self)
    def assign(self, *args): return _CharniakParser.VectorLabeledSpan_assign(self, *args)
    def resize(self, *args): return _CharniakParser.VectorLabeledSpan_resize(self, *args)
    def insert(self, *args): return _CharniakParser.VectorLabeledSpan_insert(self, *args)
    def reserve(self, *args): return _CharniakParser.VectorLabeledSpan_reserve(self, *args)
    def capacity(self): return _CharniakParser.VectorLabeledSpan_capacity(self)
    __swig_destroy__ = _CharniakParser.delete_VectorLabeledSpan
    __del__ = lambda self : None;
VectorLabeledSpan_swigregister = _CharniakParser.VectorLabeledSpan_swigregister
VectorLabeledSpan_swigregister(VectorLabeledSpan)
