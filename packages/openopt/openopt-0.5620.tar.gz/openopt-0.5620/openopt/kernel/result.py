...
class OpenOptResult: 
    ...
    def __init__(self, p):
        ...
        self._misc = {}
        for attr in ('_localtime_started', '_localtime_finished', 
                     'isObjFunValueASingleNumber', 'isFDmodel', '_init_ooarrays',
                     '_init_fixed_ooarrays', 'freeVarsSet', 'fixedVarsSet',
                     '_init_fixed_ooarrays', 'err', '_bg_color'):
...
def _txtrepr(r):
    ...
    _localtime_started, _localtime_finished, \
     isObjFunValueASingleNumber, isFDmodel, _init_ooarrays,\
     _init_fixed_ooarrays, freeVarsSet, fixedVarsSet,\
     _init_fixed_ooarrays =     M['_localtime_started'], M['_localtime_finished'], \
     M['isObjFunValueASingleNumber'], M['isFDmodel'], M['_init_ooarrays'],\
