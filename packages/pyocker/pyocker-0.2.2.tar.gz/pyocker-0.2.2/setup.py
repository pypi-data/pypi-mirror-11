...
setup(
    name = "pyocker",
    version = version,
    url = 'https://github.com/AkihikoITOH/docker_tools',
    license = 'MIT',
    ...
    package_dir = {'': 'src'},
    scripts = ['src/pyocker/dep.py', 'src/pyocker/pyocker_modules/build.py','src/pyocker/pyocker_modules/parse.py','src/pyocker/pyocker_modules/push.py','src/pyocker/pyocker_modules/validate.py'],
    # package_data={ 'src': ['*.py']},
    install_requires = ['setuptools', 'pypandoc', 'click', 'PyYaml'],
    entry_points="""
    [console_scripts]
