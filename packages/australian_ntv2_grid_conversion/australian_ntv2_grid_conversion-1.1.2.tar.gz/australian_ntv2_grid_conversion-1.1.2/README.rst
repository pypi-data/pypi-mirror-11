...
Compiled exe files for command line use on Windows are available (`Win 32bit <https://sydney-downloads.s3.amazonaws.com/PlainTech/australian_ntv2_grid_conversion/v1.1.1/australian_ntv2_grid_conversion_v1.1.1_win_32bit.zip>`_ | `Win 64bit <https://sydney-downloads.s3.amazonaws.com/PlainTech/australian_ntv2_grid_conversion/v1.1.1/australian_ntv2_grid_conversion_v1.1.1_win_64bit.zip>`_)
