...
from onyx.datatypes.gcurve import GCurve, CurveError
...
class HlocvCurve(GCurve):
    ...
    def curve(self, field="close"):
        ...
        crv.__init_raw__(self.dates,
                         self.values[:,idx], self.dtype)  # analysis:ignore
        return crv
