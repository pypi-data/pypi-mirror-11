...
from onyx.datatypes.gcurve import GCurve, Knot, CurveError
...
class RegTest(unittest.TestCase):
    ...
    def test_constructurs(self):
        ...
        crv = self.refcrv.__new__(self.refcrv.__class__)
        crv.__init_raw__(self.refcrv.dates,
                         self.refcrv.values, self.refcrv.dtype)
