...
class DatasFinanceiras(FormataData):
    ...
    def dias_uteis_por_mes(self):
        ...
        for dia in self._ListaDatas:
            if FormataData(dia).data_para_str() == self.ultimo_dia_mes(dia, 'str'):
                dias_uteis_do_mes = DatasFinanceiras(self.primeiro_dia_mes(dia, 'str'), self.ultimo_dia_mes(dia, 'str'),
