...
class SeedMe(object):
    ...
    def delete(self,
               cid, #int required
               #files=None, #string or list of string
               #keyvalues=None, #colon delimited string or dict
               #ticker=None, #string
              ):
        """Deletes collection of collection's content
        Returns JSON array
        ...
        **************************
        ...
        files           : string or list of strings
                          Filename(s) with wildcard * allowed

        keyvalues       : colon delimited string or dict, optional
                          Key Value pairs to delete in a given collection

        ticker          : string
                          Ticker text with wildcard * allowed
        """

        # ordered dictionary to collect delete info
        d_data = OrderedDict()
        ...
        # Change url when deleting a specified collection
        if isinstance(cid, int):
            self.url = self.base_url + '/' + str(cid)

        return self._do_delete_(d_data)
...
"""
    ...
    parser.add_argument('-del', '-delete',
                        ...
                        help="Delete specified collection and its content")
