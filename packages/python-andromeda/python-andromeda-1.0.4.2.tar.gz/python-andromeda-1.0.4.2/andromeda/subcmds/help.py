...
"""
    ...
    def _PrintAllCommands(self):
        print('Usage: andromeda COMMAND [ARGS]')
        print('The complete list of recognized andromeda commands are:')
        ...
        print("See 'andromeda help <command>' for more information on a "
              'specific command.')

    def _PrintCommonCommands(self):
        print('usage: andromeda COMMAND [ARGS]')
        print('The most commonly used andromeda commands are:')
        ...
        for name in commandNames:
            ...
            print(fmt % (name, summary))
        print(
            "See 'andromeda help <command>' for more information on a specific command.\n"
            "See 'andromeda help --all' for a complete list of recognized commands.")
    ...
    def Execute(self, opt, args):
        if len(args) == 0:
            ...
            try:
                ...
                print("andromeda: '%s' is not an andromeda feature." % name, file=sys.stderr)
                sys.exit(1)
