...
This is similar to running: andromeda forall -c 'echo "$ANDROMEDA_PATH : $ANDROMEDA_PROJECT"'.
"""
    ...
    def Execute(self, opt, args):
        ...
        This may be possible to do with 'andromeda forall', but andromeda newbies have
