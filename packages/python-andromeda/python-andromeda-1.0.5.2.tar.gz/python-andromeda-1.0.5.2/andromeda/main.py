...
global_options = optparse.OptionParser(
    usage="andromeda [-p|--paginate|--no-pager] COMMAND [ARGS]"
)
...
global_options.add_option('--time',
                          ...
                          help='time andromeda command execution')
global_options.add_option('--version',
                          dest='show_version', action='store_true',
                          help='display this version of andromeda')
...
class _Repo(object):
    ...
    def _Run(self, argv):
        ...
        try:
            ...
            print("repo: '%s' is not a andromeda command.  See 'andromeda help'." % name,
                  file=sys.stderr)
            return 1
...
def _CheckWrapperVersion(ver, repo_path):
    ...
    if exp[0] > ver[0] or ver < (0, 4):
        print("""A new andromeda command (%5s) is available.
...
def _Main(argv):
    ...
    opt = optparse.OptionParser(usage="andromeda wrapperinfo -- ...")
    opt.add_option("--repo-dir", dest="repodir",
                   help="path to .andromeda/")
    ...
    try:
        ...
        try:
            ...
            print('fatal: cannot restart andromeda after upgrade', file=sys.stderr)
