...
class XmlManifest(object):
    ...
    def __init__(self, repodir):
        ...
        self.repoProject = MetaProject(self, 'andromeda',
                                       gitdir=os.path.join(repodir, 'andromeda/.git'),
                                       worktree=os.path.join(repodir, 'andromeda'))
    ...
    @property
    def IsMirror(self):
        return self.manifestProject.config.GetBoolean('andromeda.mirror')

    @property
    def IsArchive(self):
        return self.manifestProject.config.GetBoolean('andromeda.archive')
