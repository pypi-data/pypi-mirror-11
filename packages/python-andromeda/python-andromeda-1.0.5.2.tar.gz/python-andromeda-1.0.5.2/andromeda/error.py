...
class RepoChangedException(Exception):
    """
    Thrown if 'andromeda sync' results in andromeda updating its internal
       andromeda or manifest repositories.  In this special case we must
       use exec to re-execute andromeda with the new code and manifest.
    """
...
class HookError(Exception):
    """
    Thrown if a 'andromeda-hook' could not be run.
