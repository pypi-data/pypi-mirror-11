    ...
    def __init__(self, configfile, defaults=None, jsonFile=None):
        ...
        if self._json is None:
            self._json = os.path.join(
                ...
                '.andromeda_' + os.path.basename(self.file) + '.json')
...
def _open_ssh(host, port=None):
    ...
    # one that was passed to andromeda init.
...
class Remote(object):
    ...
    def __init__(self, config, name):
        ...
        # TODO this might be the way to go about it, but I think it's for the remote.
        self._review_url = None
        # self.reviewname = self._Get('')
    ...
    def ReviewUrl(self, userEmail):
        if self._review_url is None:
            ...
            elif 'ANDROMEDA_HOST_PORT_INFO' in os.environ:
                host, port = os.environ['ANDROMEDA_HOST_PORT_INFO'].split()
