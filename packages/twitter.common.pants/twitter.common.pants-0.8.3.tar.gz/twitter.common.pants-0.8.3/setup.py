...
# Target: PythonLibrary(BuildFileAddress(FilesystemBuildFile(/Users/stuhood/src/commons/pants-plugins/src/python/twitter/common/pants/BUILD), plugins))
...
{   'classifiers': [   'Intended Audience :: Developers',
    ...
    'install_requires': [   'pantsbuild.pants>=0.0.28,<0.1.0',
                            'twitter.common.contextutil==0.3.4',
