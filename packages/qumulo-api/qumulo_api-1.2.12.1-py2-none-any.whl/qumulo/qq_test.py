...
class PublicQQCommandsMixin(object):
    ...
    def test_ad_set_machine_account_help(self):
        self.do_help_test('ad_set_machine_account')
    ...
    def test_fs_walk_help(self):
        self.do_help_test('fs_walk')
...
class QQTest(unittest.TestCase, PublicQQCommandsMixin):
    ...
    def setUp(self):
        ...
        self.qq_fs = posix_fs.TestFileSystem(cli_fs.translate('cli'))
...
def copy_path(dir_, dst_fs=None):
    ...
    '''
    src_fs = posix_fs.TestFileSystem(qpaths.find_src_root())
