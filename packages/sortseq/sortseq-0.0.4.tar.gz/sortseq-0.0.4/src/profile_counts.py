...
def main(df,dicttype,wtseq=None,return_wtseq=False):
...
def wrapper(args):
    ...
    output_df = main(df,args.type,wtseq=wtseq)
...
def add_subparser(subparsers):
    ...
    p.add_argument('-b','--bin',default=None,help='''Bin where mutation rate will
