...
emats = np.load('/home/bill/RNAseq/libcounts_test_emats_v1.npy')
MI = np.zeros([100])
...
for z in range(100):
        ...
        print MI[z]
np.save('/home/bill/RNAseq/MIRNA_test_libcounts',MI)
...
ematdf = learn_model.main(df,'dna','least_squares',exptype='mpra')
