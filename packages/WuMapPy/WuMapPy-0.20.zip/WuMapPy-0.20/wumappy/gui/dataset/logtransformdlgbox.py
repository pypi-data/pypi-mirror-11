...
class LogTransformDlgBox:
    ...
    def new(cls, title, parent, multfactor=0):
        ...
        window.items_list = [['Label', 'MULTFACTOR_ID', 0, 0, False, None, None],  
                           ['SpinBox', '', 1, 0, True, window.MultFactorInit, window.MultFactorUpdate],    
                           ['Label', 'LOGTRANSFORM_MSG', 2, 0, False, None, None],
                           ['Label', '', 3, 0, False, None, None],
                           ['Label', 'LOGTRANSFORM_REF', 4, 0, False, None, None],
                           ['Label', '', 5, 0, False, None, None],
                           ['Label', 'MINIMALVALUE_ID', 6, 0, False, None, None],  
                           ['DoubleSpinBox', '', 7, 0, True, window.MinimalValuebySpinBoxInit, window.MinimalValuebySpinBoxUpdate],    
                           ['Slider', '', 8, 0, True, window.MinimalValuebySliderInit, window.MinimalValuebySliderUpdate],  
                           ['Label', '', 9, 0, False, None, None],  
                           ['Label', 'MAXIMALVALUE_ID', 10, 0, False, None, None],  
                           ['DoubleSpinBox', '', 11, 0, True, window.MaximalValuebySpinBoxInit, window.MaximalValuebySpinBoxUpdate],    
                           ['Slider', '', 12, 0, True, window.MaximalValuebySliderInit, window.MaximalValuebySliderUpdate],
                           ['Label', '', 13, 0, False, None, None],  
                           ['Image', '', 14, 0, False, window.HistoImageInit, None],   
                           ['Label', '', 15, 0, False, None, None],  
                           ['MiscButton', 'DISPUPDATE_ID', 16, 0, True, window.DispUpdateButtonInit, window.DispUpdateButtonUpdate],   
                           ['ValidButton', 'VALID_ID', 17, 0, True, window.ValidButtonInit, None],   
                           ['CancelButton', 'CANCEL_ID', 18, 0, True, window.CancelButtonInit, None],   
