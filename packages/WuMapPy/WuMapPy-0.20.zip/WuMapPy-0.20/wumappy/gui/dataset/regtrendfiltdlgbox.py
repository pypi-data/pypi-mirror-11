...
class RegTrendFiltDlgBox:
    ...
    def new(cls, title, parent, nxsize=3, nysize=3, method='rel', component='loc'):
        ...
        window.items_list = [['Label', 'FILTERNXSIZE_ID', 0, 0, False, None, None],  
                           ...
                           ['Label', 'FILTERNYSIZE_ID', 3, 0, False, None, None],  
                           ['SpinBox', '', 4, 0, True, window.NySizeInit, window.NySizeUpdate],    
                           ['Label', '', 5, 0, False, None, None],  
                           ['Label', 'REGTRENDMETHOD_ID', 6, 0, False, None, None],  
                           ['ComboBox', '', 7, 0, True, window.MethodInit, window.MethodUpdate],   
                           ['Label', '', 8, 0, False, None, None],  
                           ['Label', 'REGTRENDCOMPONENT_ID', 9, 0, False, None, None],  
                           ['ComboBox', '', 10, 0, True, window.ComponentInit, window.ComponentUpdate],   
                           ['Label', '', 11, 0, False, None, None],  
                           ['MiscButton', 'DISPUPDATE_ID', 12, 0, True, window.DispUpdateButtonInit, window.DispUpdateButtonUpdate],   
                           ['ValidButton', 'VALID_ID', 13, 0, True, window.ValidButtonInit, None],   
                           ['CancelButton', 'CANCEL_ID', 14, 0, True, window.CancelButtonInit, None],   
