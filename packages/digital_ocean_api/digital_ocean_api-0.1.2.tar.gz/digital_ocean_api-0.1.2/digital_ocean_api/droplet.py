...
# get droplets by name prefix
def get_by_prefix(prefix):
    return [droplet for droplet in list_all()['droplets'] if droplet['name'].startswith(prefix)]
...
def create(name, snapshot_id = '13286601', region = 'nyc2'):
    payload = {
