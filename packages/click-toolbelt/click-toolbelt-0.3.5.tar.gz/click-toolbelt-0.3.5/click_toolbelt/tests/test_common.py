...
class AuthenticatedCommandTestCase(CommandTestCase):
    command_class = AuthenticatedCommand

    def test_take_action(self):
        self.assertIsNone(self.command.take_action(None))


class GetConfigTestCase(AuthenticatedCommandTestCase):
...
class GetOAuthSessionTestCase(AuthenticatedCommandTestCase):

    def setUp(self):
        super(GetOAuthSessionTestCase, self).setUp()
        patcher = patch(
            'click_toolbelt.common.AuthenticatedCommand.get_config')
