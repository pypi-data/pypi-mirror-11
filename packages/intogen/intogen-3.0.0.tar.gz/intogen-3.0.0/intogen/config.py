...
class ConfigManager(object):
    ...
    def __init__(self, options=None, tasks=None):
        ...
        log_level = logging.INFO if not drmaa.DEBUGGING else logging.DEBUG
        ...
        if options is not None:
            ...
            scheduler_config = ConfigObj(os.path.join(self.home_path, 'scheduler.conf'), interpolation='intogen', configspec=config_specs)
