...
from batchcompute.utils import (
    RequestClient, get_service, str_md5, utf8, iget, gmt_time, import_json,
)
from batchcompute.utils.constants import API_VERSION, PY2, PY3
...
class Api(object):
    ...
    def __init__(self, region, access_id, secret_key):
        self.region = region
        self.host, self.port = get_service(region)
