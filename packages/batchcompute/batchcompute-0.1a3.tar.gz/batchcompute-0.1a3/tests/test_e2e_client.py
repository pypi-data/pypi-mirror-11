...
from batchcompute import JobDescription, TaskDescription, TaskDag, ResourceDescription, Client, ClientError

class ClientE2ETest(unittest.TestCase):
    def setUp(self):
        self.region = 'cn-qingdao'
        self.access_key_id = ""
        self.access_key_secret = ""
        self.image_id = ''

        self.client = Client(self.region, self.access_key_id,
    ...
    def test_list_tasks(self):
        ...
        for task in task_list:
            print task.TaskName
            for instance in task.InstanceStatusList:
