...
# Imports =====================================================================
"""
AMQP binding for aleph_link_export subsystem. See `edeposit.amqp.aleph_link_export
<https://github.com/edeposit/edeposit.amqp.aleph_link_export>`_ for details.
"""
import os
import sys
import os.path
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        ...
        description="""AMQP binding for aleph_link_export subsystem."""
    )
    parser.add_argument(
        "action",
