...
static PyObject *pngdefry_process(PyObject * self, PyObject * args)
{
    char *input_file;
    char *output_file;
    long result=0;
    ...
    result = (long)process(input_file, output_file, &width, &height);
    return PyInt_FromLong(result);
}

static PyMethodDef PngDefryMethods[] = {
    { "process", pngdefry_process, METH_VARARGS, "pngdefry: reverse iOS PNG optimizations" },
    { NULL, NULL, 0, NULL}
};

DL_EXPORT(void) init_pngdefry(void)
{
    Py_InitModule("_pngdefry", PngDefryMethods);
}
