...
# It could also be useful to have the orderedset version of an intspan, eg to
# describe orderings of items. Spanlist below is a start on this kind of
# feature. Though not a full class mapped to Python ABCs, a partial provision.
...
class intspanlist(list):
    ...
    def __gt__(self, items):
        return super(inintspanlisttspan, self).__gt__(spanlist(items))
