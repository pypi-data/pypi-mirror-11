...
class TVerifyResult(object):
  ...
  thrift_spec = (
    ...
    (4, TType.I32, 'proxyProtocolVersion', None, 2, ), # 4
  )
...
class TWriteOptions(object):
  ...
  def __init__(self, durability=None, timeoutMs=None, returnChoice=None,):
...
class TRow(object):
  ...
  def __init__(self, jsonRow=None,):
...
class TWriteResult(object):
  ...
  def __init__(self, currentRowVersion=None, previousRow=None, previousRowVersion=None, wasDeleted=None,):
...
class TGetResult(object):
  ...
  def __init__(self, currentRow=None, currentRowVersion=None,):
...
class TRowAndMetadata(object):
  ...
  def __init__(self, jsonRow=None, rowVersion=None, tableId=None,):
    self.jsonRow = jsonRow
