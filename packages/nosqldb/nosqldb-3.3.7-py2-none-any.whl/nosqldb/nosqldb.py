...
# nosqldb.py: This file contains most of the public classes avaialble for
#the Ocacle NoSQL DB API for Python:
...
#    value for those functions that return rows. This is underneat a simple
...
class Factory:
    ...
    # This method is going to try to connnect to the proxy.
...
class Store:
    ...
    def index_iterator(self, table, index_name, key, key_only,
        ...
        """
        Returns an iterable list of :py:class:`Row` objects or keys which
        match the identified index.

        :param table: The name of the table from which you want to retrieve
            the keys. This parameter is required.
        :param index_name: The index you want to use. This parameter is
            required.
        :param partial_key: A :py:class:`Row` object containing the
            partial primary key. This parameter is required.
        :param key_only: ``True`` if you want to obtain only keys from the
