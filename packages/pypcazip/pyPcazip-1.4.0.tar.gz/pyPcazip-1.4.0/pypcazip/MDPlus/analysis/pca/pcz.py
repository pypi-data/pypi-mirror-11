...
class Pcz:
    ...
    def avg(self):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> print(np.allclose(p.avg()[0], np.array([ 31.323149, 61.575380, 40.136298]), atol=0.0001, rtol=0.0001))
        True
    ...
    def eval(self, ival):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> print(np.allclose(p.eval(4), np.array([2.6183940]), rtol=0.0001, atol=0.0001))
        True
    ...
    def evals(self):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> print(np.allclose(p.evals()[4], np.array([2.6183940]), rtol=0.0001, atol=0.0001))
        True
    ...
    def evec(self, ivec):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> print(np.allclose(abs(p.evec(1)[12]), np.array([0.00865751377]), rtol=0.0001, atol=0.0001))
        True
    ...
    def evecs(self):
        ...
        >>> element = abs(e[1,12])
        >>> print(np.allclose(element, np.array([0.0086575138]), rtol=0.0001, atol=0.0001))
        True
    ...
    def proj(self, iproj):
        ...
        >>> p = Pcz(c)
        >>> prj = abs(p.proj(3))
        >>> print(np.allclose(prj[21], 0.345995549, rtol=0.0001, atol=0.0001))
        True
    ...
    def scores(self, framenumber):
        ...
        >>> p = Pcz(c)
        >>> s = abs(p.scores(12))
        >>> print(np.allclose(s[3], 0.59478410, rtol=0.0001, atol=0.0001))
        True
    ...
    def expand(self, scores):
        ...
        >>> print(np.allclose(e[3:6], [2.543986, 0.957343, 2.214452], rtol=0.0001, atol=0.0001))
        True
    ...
    def map(self,crds):
        ...
        >>> print(np.allclose(abs(p.map(crds)[:3]),[0.3844803, 1.6537842, 2.29433996], rtol=0.0001, atol=0.0001))
        True
