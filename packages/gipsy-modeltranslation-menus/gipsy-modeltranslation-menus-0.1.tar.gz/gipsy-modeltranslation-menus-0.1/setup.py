...
from gipsy.modeltranslation.menus import __doc__ as description
from gipsy.modeltranslation.menus import __version__ as version
...
setup(
    name='gipsy-modeltranslation-menus',
    version=version,
    author=u'Rafał Selewońko',
    author_email='rafal@selewonko.com',
    description=description,
    url='http://github.com/revsquare/gipsy-modeltranslation-menus',
    packages=['gipsy'],
