...
def main():
  ...
  group1 = my_cool_parser.add_mutually_exclusive_group()
  group1.add_argument('-t', '--verbozze', dest='verbose', action="store_true", help="Show more details")
  group1.add_argument('-q', '--quiet', dest='quiet', action="store_true", help="Only output on error")

  group2 = my_cool_parser.add_mutually_exclusive_group()
  group2.add_argument('-b', '--berbozze', dest='berbose', action="store_true", help="Show more details")
  group2.add_argument('-g', '--guiet', dest='guiet', action="store_true", help="Only output on error")
