...
# Auto-generated file for API static documentation stubs (2015-09-24T20:26:32.221853)
#
# **DO NOT EDIT**
...
class CollaborativeFilteringModel(object):
    ...
    def train(self, frame, user_col_name, item_col_name, rating_col_name, evaluation_function=None, num_factors=None, max_iterations=None, convergence_threshold=None, regularization=None, bias_on=None, min_value=None, max_value=None, learning_curve_interval=None, cgd_iterations=None):
        ...
        :param frame: 
        :type frame: <bound method AtkEntityType.__name__ of <trustedanalytics.rest.jsonschema.AtkEntityType object at 0x7f9e686f3fd0>>
...
class RandomForestClassifierModel(object):
    ...
    @doc_stub
    def train(self, frame, label_column, observation_columns, num_classes=2, num_trees=1, impurity='gini', max_depth=4, max_bins=100, seed=-686633978, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :param max_bins: (default=100)  Maximum number of bins used for
            splitting features.
        :type max_bins: int32
        :param seed: (default=-686633978)  Random seed for bootstrapping and
...
class RandomForestRegressorModel(object):
    ...
    @doc_stub
    def train(self, frame, label_column, observation_columns, num_trees=1, impurity='variance', max_depth=4, max_bins=100, seed=2145878081, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :type max_bins: int32
        :param seed: (default=2145878081)  Random seed for bootstrapping and choosing feature subsets
        :type seed: int32
        :param categorical_features_info: (default=None)  
        :type categorical_features_info: None
