...
# Auto-generated file for API static documentation stubs (2015-09-24T20:26:32.217481)
#
# **DO NOT EDIT**
...
class _DocStubsEdgeFrame(object):
    ...
    def __init__(self, graph=None, label=None, src_vertex_label=None, dest_vertex_label=None, directed=None):
        ...
        :param graph: (default=None)  graph these edges belong to
        :type graph: ?
        :param label: (default=None)  edge label
        :type label: ?
        :param src_vertex_label: (default=None)  label of the source vertex type
        :type src_vertex_label: ?
        :param dest_vertex_label: (default=None)  label of the destination vertex type
        :type dest_vertex_label: ?
        :param directed: (default=None)  directed or undirected
        :type directed: ?

        :returns: An object with access to the frame.
        :rtype: EdgeFrame
        """
    ...
    def add_columns(self, func, schema, columns_accessed=None):
        ...
        *column3*, and *column4*.
        ...
        :param func: User-Defined Function (|UDF|) which takkes the values in the row and produces a value, or collection of values, for the new cell(s).
        :type func: UDF
    ...
    def add_edges(self, source_frame, column_name_for_source_vertex_id, column_name_for_dest_vertex_id, column_names=None, create_missing_vertices=False):
        ...
        :param source_frame: Frame that will be the source of
            the edge data.
        :type source_frame: <bound method AtkEntityType.__name__ of <trustedanalytics.rest.jsonschema.AtkEntityType object at 0x7f9e686f3fd0>>
    ...
    def compute_misplaced_score(self, gravity):
        ...
        :returns: 
        :rtype: <bound method AtkEntityType.__name__ of <trustedanalytics.rest.jsonschema.AtkEntityType object at 0x7f9e686f3fd0>>
        """
        return None
    ...
    @doc_stub
    def inspect(self, n=10, offset=0, columns=None, wrap=None, truncate=None, round=None, width=80, margin=None):
        """
        ...
        :type columns: int
        :param wrap: (default=None)  If set to 'stripes' then inspect prints rows in stripes; if set to an integer N, rows will be printed in clumps of N columns, where the columns are wrapped
        :type wrap: int or 'stripes'
        :param truncate: (default=None)  If set to integer N, all strings will be truncated to length N, including a tagged ellipses
        :type truncate: int
        :param round: (default=None)  If set to integer N, all floating point numbers will be rounded and truncated to N digits
        :type round: int
        :param width: (default=80)  If set to integer N, the print out will try to honor a max line width of N
        :type width: int
        :param margin: (default=None)  ('stripes' mode only) If set to integer N, the margin for printing names in a stripe will be limited to N characters
        :type margin: int
        """
        return None
