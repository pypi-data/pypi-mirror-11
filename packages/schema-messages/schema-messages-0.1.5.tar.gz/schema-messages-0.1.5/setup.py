...
if use_cython:
    ext_modules += [
        ...
        Extension("schemamessages.factory", [ "schemamessages/exceptions.pyx" ]),
        Extension("schemamessages.packers", [ "schemamessages/exceptions.pyx" ]),
        Extension("schemamessages.unpackers", [ "schemamessages/exceptions.pyx" ]),
        Extension("schemamessages.utils", [ "schemamessages/exceptions.pyx" ]),
    ]
    cmdclass.update({ 'build_ext': build_ext })
else:
    ext_modules += [
        Extension("schemamessages.exceptions", [ "schemamessages/exceptions.c" ]),
        Extension("schemamessages.factory", [ "schemamessages/exceptions.c" ]),
        Extension("schemamessages.packers", [ "schemamessages/exceptions.c" ]),
        Extension("schemamessages.unpackers", [ "schemamessages/exceptions.c" ]),
        Extension("schemamessages.utils", [ "schemamessages/exceptions.c" ]),
    ]
