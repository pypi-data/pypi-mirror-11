...
def plot_profiles(exp_filename, config):
    ...
    dat_speck = pd.read_csv(config.resultsfolder + exp_filename + '_intensities_speck.csv')
    dat_hom = pd.read_csv(config.resultsfolder + exp_filename + '_intensities_hom.csv')

    dat_classes = pd.read_csv(config.resultsfolder + exp_filename + '_classes.csv')
    dat_features = pd.read_csv(config.resultsfolder + exp_filename + '_features.csv')
    ...
    savefolder = config.resultsfolder + exp_filename + '_plots/' 
