...
def is_mobile(request):
    ...
    result = False
    user_agent = request.META.get('HTTP_USER_AGENT',None).lower()
    mobile_list = ["Android", "iPhone", "SymbianOS", "Windows Phone", "iPad", "iPod","wechat"]
...
if __name__ == '__main__':
    ...
    print(get_url_content(url='http://bdapp.bandao.cn/bandao/api/newslist.php?pagesize=20&pageno=1&typeid=1'))
