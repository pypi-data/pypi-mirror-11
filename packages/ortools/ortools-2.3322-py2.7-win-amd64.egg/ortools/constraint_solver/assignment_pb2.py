...
IntVarAssignmentProto = _reflection.GeneratedProtocolMessageType('IntVarAssignmentProto', (_message.Message,), dict(
...
_sym_db.RegisterMessage(IntVarAssignmentProto)

IntervalVarAssignmentProto = _reflection.GeneratedProtocolMessageType('IntervalVarAssignmentProto', (_message.Message,), dict(
  DESCRIPTOR = _INTERVALVARASSIGNMENTPROTO,
  __module__ = 'ortools.constraint_solver.assignment_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.IntervalVarAssignmentProto)
  ))
_sym_db.RegisterMessage(IntervalVarAssignmentProto)

SequenceVarAssignmentProto = _reflection.GeneratedProtocolMessageType('SequenceVarAssignmentProto', (_message.Message,), dict(
  DESCRIPTOR = _SEQUENCEVARASSIGNMENTPROTO,
  __module__ = 'ortools.constraint_solver.assignment_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.SequenceVarAssignmentProto)
  ))
_sym_db.RegisterMessage(SequenceVarAssignmentProto)
