...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[ortools.constraint_solver.search_limit_pb2.DESCRIPTOR,])
...
CPIntegerMatrixProto = _reflection.GeneratedProtocolMessageType('CPIntegerMatrixProto', (_message.Message,), dict(
...
_sym_db.RegisterMessage(CPIntegerMatrixProto)

CPArgumentProto = _reflection.GeneratedProtocolMessageType('CPArgumentProto', (_message.Message,), dict(
  DESCRIPTOR = _CPARGUMENTPROTO,
  __module__ = 'ortools.constraint_solver.model_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.CPArgumentProto)
  ))
_sym_db.RegisterMessage(CPArgumentProto)

CPExtensionProto = _reflection.GeneratedProtocolMessageType('CPExtensionProto', (_message.Message,), dict(
  DESCRIPTOR = _CPEXTENSIONPROTO,
  __module__ = 'ortools.constraint_solver.model_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.CPExtensionProto)
  ))
_sym_db.RegisterMessage(CPExtensionProto)

CPIntegerExpressionProto = _reflection.GeneratedProtocolMessageType('CPIntegerExpressionProto', (_message.Message,), dict(
  DESCRIPTOR = _CPINTEGEREXPRESSIONPROTO,
  __module__ = 'ortools.constraint_solver.model_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.CPIntegerExpressionProto)
  ))
_sym_db.RegisterMessage(CPIntegerExpressionProto)

CPIntervalVariableProto = _reflection.GeneratedProtocolMessageType('CPIntervalVariableProto', (_message.Message,), dict(
  DESCRIPTOR = _CPINTERVALVARIABLEPROTO,
  __module__ = 'ortools.constraint_solver.model_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.CPIntervalVariableProto)
  ))
_sym_db.RegisterMessage(CPIntervalVariableProto)

CPSequenceVariableProto = _reflection.GeneratedProtocolMessageType('CPSequenceVariableProto', (_message.Message,), dict(
  DESCRIPTOR = _CPSEQUENCEVARIABLEPROTO,
  __module__ = 'ortools.constraint_solver.model_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.CPSequenceVariableProto)
  ))
_sym_db.RegisterMessage(CPSequenceVariableProto)

CPConstraintProto = _reflection.GeneratedProtocolMessageType('CPConstraintProto', (_message.Message,), dict(
  DESCRIPTOR = _CPCONSTRAINTPROTO,
  __module__ = 'ortools.constraint_solver.model_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.CPConstraintProto)
  ))
_sym_db.RegisterMessage(CPConstraintProto)
