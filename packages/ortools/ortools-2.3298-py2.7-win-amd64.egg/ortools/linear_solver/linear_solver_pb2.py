...
_PARTIALVARIABLEASSIGNMENT.fields_by_name['var_index']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_PARTIALVARIABLEASSIGNMENT.fields_by_name['var_value'].has_options = True
_PARTIALVARIABLEASSIGNMENT.fields_by_name['var_value']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
