...
class BaseImageBatchView(AdminBatchUploadView):      

    template_name = 'admin/media/image/batch.html'
    ...
    fields = ['title','credit', 'caption', 'alt', 'admin_description','use_png',
        'clean_filename_on_upload', 'allow_file_to_override', 'creator', 'tags', ]

    default_fields = ['credit', 'caption', 'admin_description', 'use_png', 
         'clean_filename_on_upload', 'allow_file_to_override', 
        'creator', 'tags']

    detail_fields = ['title','alt', 'credit', 'caption', 'use_png', ]
    

class BaseSecureImageBatchView(BaseImageBatchView):      
    #model = SecureImage
    #form_class = SecureImageAddForm
    pass
   

class BaseDocumentBatchView(AdminBatchUploadView):      
    ...
    fields = ['title','admin_description', 
         'is_searchable', 'clean_filename_on_upload', 
        'allow_file_to_override', 'creator', 'tags']

    default_fields = [ 'admin_description', 
        'is_searchable', 'clean_filename_on_upload', 'allow_file_to_override', 
        'creator', 'tags']

    detail_fields = ['title','is_searchable',]

class BaseSecureDocumentBatchView(BaseDocumentBatchView):      
    #model = SecureDocument
    #form_class = SEcureDocumentAddForm
    pass
