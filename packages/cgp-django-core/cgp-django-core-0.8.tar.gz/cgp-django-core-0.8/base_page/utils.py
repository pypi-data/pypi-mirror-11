...
def get_page_templates(default_template = 'pages/default.html', template_dir='pages/', ignore_templates = None):
    """
    ...
    items = [(i, name(i)) for i in files if not i in ignore_templates] 
    items.sort()
    return items
