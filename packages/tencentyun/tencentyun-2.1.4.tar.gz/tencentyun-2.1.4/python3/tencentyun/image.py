...
class Image(object):
    ...
    def upload(self, image_file, userid = '0', magic_context = '', params = {}):
        # if image file is provided as a filepath
        if isinstance(image_file, str):
            filepath = os.path.abspath(image_file)
            if os.path.exists(filepath):
                return self.upload_impl(open(filepath, 'rb'), userid, magic_context, params)
            else:
        ...
        # if image file is provided as in-memory binary
            ...
            return self.upload_impl(image_file, userid, magic_context, params)
        else:
    ...
    def upload_binary(self, binary_file, userid = '0', magic_context = '', params = {}):
        return self.upload_impl(binary_file, userid, magic_context, params)
