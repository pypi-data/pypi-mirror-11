...
usage = """
This is PyFac version 1.0.0.

USAGE:
    pyfac [-vs|-sv] [-v|--verbose] [-s|--summary] [-t=NUM] [-r=NUM]
...
DETAILS:
    Factoring: 1.  Trial divide using the primes <= the specified limit.
               ...
               Using the "verbose" option will cause PyFac to report which of
...
# TODO command-line options to tweak multifactor components
# TODO timeout?
