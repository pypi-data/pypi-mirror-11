...
#
def add_user_to_category_group(iam_client, current_groups, category_groups, category_regex, user, user_info = None, dry_run = False, auto_only = False):
        ...
        if not len(category_memberships):
            ...
            if len(category_regex):
                ...
                sys.stdout.flush()
            if not group and not auto_only and prompt_4_yes_no('Do you want to remediate this now'):
