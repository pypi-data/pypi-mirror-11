...
Last edit: $Author: bgoli $ ($Id: CBModel.py 374 2015-09-03 15:16:36Z bgoli $)
...
class Objective(Fbase):
    ...
    def getFluxObjectiveForReaction(self, rid):
        """
        Returns the FluxObjective associated with the suplied rid.
        ...
        for fo_ in self.fluxObjectives:
            if fo_.reaction == rid:
                if fo == None:
                    ...
                    fo.append(fo_)
                    print('\nWARNING: multiple FluxBounds have id: {}\n'.format(rid))
                else:
                    fo = [fo]
                    fo.append(fo_)
                    print('\nWARNING: multiple FluxBounds have id: {}\n'.format(rid))
    ...
    # not needed, left here just in case
    #def clone(self):
        #"""
        #Return a clone of this object.
        ...
        #out.fluxObjectives = []
        #for rr_ in self.fluxObjectives:
            #out.addFluxObjective(rr_.clone())
        #return out
